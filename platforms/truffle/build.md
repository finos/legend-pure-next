...
│   └── cp runtime/target/pure-truffle-*-fat.jar → truffle/build/pure-truffle.jar
└── body
    └── pure-truffle execute meta::pure::test::runCompiledGraphTests pure/specification/compiler
```
...
│       └── cp runtime/target/pure-truffle-native → truffle/build/pure-truffle-native
└── body
    └── pure-truffle-native execute meta::pure::test::runCompiledGraphTests pure/specification/compiler
```
