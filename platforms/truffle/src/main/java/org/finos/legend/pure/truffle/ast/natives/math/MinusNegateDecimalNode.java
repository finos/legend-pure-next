...
@NodeInfo(shortName = "negateDec")
public final class MinusNegateDecimalNode extends PureNode
{
    @Child
    private PureNode operand;

    public MinusNegateDecimalNode(PureNode operand)
    {
    ...
    {
        return negate(operand.executeGeneric(frame));
    }

    @TruffleBoundary
    private static BigDecimal negate(Object v)
    {
