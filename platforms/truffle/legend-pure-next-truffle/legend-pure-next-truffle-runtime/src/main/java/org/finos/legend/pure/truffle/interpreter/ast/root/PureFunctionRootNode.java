...
package org.finos.legend.pure.truffle.interpreter.ast.root;
...
public final class PureFunctionRootNode extends RootNode
{
    ...
    private static Object resolveTypeFromArgument(Object arg,
                                                  TruffleMetadataAccess resolver)
    {
        if (arg instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject)
        {
            Object cgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(arg,
