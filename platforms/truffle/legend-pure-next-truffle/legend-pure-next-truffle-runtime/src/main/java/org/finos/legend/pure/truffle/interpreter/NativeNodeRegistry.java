...
public final class NativeNodeRegistry
{
    ...
    public static NativeNodeRegistry createDefault()
    {
        ...
        org.finos.legend.pure.truffle.interpreter.ast.natives.math.MathNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.boolean_.BooleanNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.string.StringNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.collection.CollectionNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.lang.LangNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.meta.MetaNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.meta.antlr.AntlrNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.io.IONodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.binary.BinaryNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.assert_.AssertNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.date.DateNodeFactories.registerAll(registry);
        org.finos.legend.pure.truffle.interpreter.ast.natives.variant.VariantNodeFactories.registerAll(registry);
        ...
        // Each jar's META-INF/services/org.finos.legend.pure.truffle.interpreter.TruffleNativesExtension
