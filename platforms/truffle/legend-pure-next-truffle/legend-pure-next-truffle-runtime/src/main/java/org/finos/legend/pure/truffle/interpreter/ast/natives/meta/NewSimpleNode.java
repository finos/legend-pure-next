...
public final class NewSimpleNode extends PureNode
{
            ...
            TruffleMetadataAccess resolver)
    {
        ...
        Object holderGT = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(result, SLOT_GENERIC_TYPE);
        ...
        if (typeArgs != null && typeArgs.size() > 0)
        {
            ...
            if (heldType != null)
            {
                ...
                {
                    Object n = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(heldType, SLOT_NAME);
