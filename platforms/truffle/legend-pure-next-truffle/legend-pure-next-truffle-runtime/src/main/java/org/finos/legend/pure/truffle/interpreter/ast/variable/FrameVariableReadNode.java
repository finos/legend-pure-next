 ...
 * org.finos.legend.pure.truffle.interpreter.FrameDescriptorBuilder}). The slot
...
public final class FrameVariableReadNode extends PureNode
{
    ...
    public Object executeGeneric(VirtualFrame frame)
    {
        if (slot < 0)
        {
            ...
            throw new org.finos.legend.pure.truffle.interpreter.ast.PureException("Unknown variable: " + name, this);
        }
