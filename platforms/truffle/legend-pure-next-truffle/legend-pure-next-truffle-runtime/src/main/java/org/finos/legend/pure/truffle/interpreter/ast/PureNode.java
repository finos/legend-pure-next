...
package org.finos.legend.pure.truffle.interpreter.ast;
...
public abstract class PureNode extends Node
{
     ...
     * Producers (e.g. {@link org.finos.legend.pure.truffle.interpreter.ast.natives.boolean_.NotBooleanNode},
     * {@link org.finos.legend.pure.truffle.interpreter.ast.natives.lang.AndNode}) override
     * this to return a primitive {@code boolean} directly — letting consumers
     * (e.g. {@link org.finos.legend.pure.truffle.interpreter.ast.natives.lang.IfNode}'s
    ...
    @com.oracle.truffle.api.CompilerDirectives.TruffleBoundary
    protected final TruffleMetadataAccess getResolver()
    {
