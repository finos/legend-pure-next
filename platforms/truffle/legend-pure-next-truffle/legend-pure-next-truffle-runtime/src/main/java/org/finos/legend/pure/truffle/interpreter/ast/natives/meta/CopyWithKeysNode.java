...
package org.finos.legend.pure.truffle.interpreter.ast.natives.meta;
...
public final class CopyWithKeysNode extends PureNode
{
    ...
    private static final int SLOT_DEFAULT_VALUE = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("defaultValue");
    ...
    private static final int SLOT_GENERAL = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("general");
    private static final int SLOT_GENERALIZATIONS = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("generalizations");
    private static final int SLOT_MULTIPLICITY_ARGUMENTS = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("multiplicityArguments");
    private static final int SLOT_MULTIPLICITY_PARAMETERS = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("multiplicityParameters");
    ...
    private static final int SLOT_PROPERTIES = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("properties");
    private static final int SLOT_PROPERTIES_FROM_ASSOCIATIONS = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("propertiesFromAssociations");
    private static final int SLOT_TYPE = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("type");
    private static final int SLOT_TYPE_PARAMETERS = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("typeParameters");
    ...
    @Children
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyAssignNode[] assignments;

    @Child
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode deepReader = new org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode();

    @Child
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyWriteNode deepWriter = new org.finos.legend.pure.truffle.interpreter.ast.property.PropertyWriteNode();

    @Child
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode topPropReader = new org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode();

    @Child
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode subCopyReader = new org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode();

    @Child
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode appendReader = new org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode();

    @Child
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyWriteNode appendWriter = new org.finos.legend.pure.truffle.interpreter.ast.property.PropertyWriteNode();

    public CopyWithKeysNode(String signature, PureNode sourceNode, org.finos.legend.pure.truffle.interpreter.ast.property.PropertyAssignNode[] assignments)
    {
     ...
     * types like {@link org.finos.legend.pure.truffle.types.MapImpl}
    ...
    {
        if (instance instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdo)
        {
                                ...
                                org.finos.legend.pure.truffle.PureContext eval)
    {
        ...
        for (String topProp : topLevelDeepProps)
        {
            ...
            Object subCgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(subCopy, SLOT_CLASSIFIER_GENERIC_TYPE);
            if (subCgt != null)
            {
    ...
    private Object invoke(VirtualFrame frame)
    {
        ...
        Object cgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(original, SLOT_CLASSIFIER_GENERIC_TYPE);
        ...
        if (copyCgt != null)
        {
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(copy, "classifierGenericType", copyCgt);
        }
     ...
     */
    @com.oracle.truffle.api.CompilerDirectives.TruffleBoundary
    private static String resolveClassPathFromCGT(Object cgt, TruffleMetadataAccess resolver)
    {
     ...
     */
    @com.oracle.truffle.api.CompilerDirectives.TruffleBoundary
    private static java.util.List<String> collectAllPropertyNames(Object type, TruffleMetadataAccess resolver)
    {
                                                       ...
                                                       TruffleMetadataAccess resolver)
    {
        ...
        Object propsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_PROPERTIES);
        if (propsObj instanceof PureSequence ps) addPropertyNamesFromSeq(ps, names, seen);
        Object pfaObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_PROPERTIES_FROM_ASSOCIATIONS);
        if (pfaObj instanceof PureSequence pfa) addPropertyNamesFromSeq(pfa, names, seen);
        Object gens = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_GENERALIZATIONS);
        if (gens instanceof PureSequence seq)
        {
            for (Object gen : seq.toBoxedArray())
            {
                Object general = gen != null
                        ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(gen, SLOT_GENERAL) : null;
                if (general != null)
                {
    ...
    private static void addPropertyNamesFromSeq(PureSequence seq, java.util.List<String> names, java.util.Set<String> seen)
    {
        ...
        for (Object prop : seq.toBoxedArray())
        {
            ...
            Object n = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(prop, SLOT_NAME);
     ...
     * org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject} and
    ...
    {
        if (!(source instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdoSrc)
                || !(target instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdoTgt))
        {
            return;
        }
        ...
        for (int i = 0; i < n; i++)
        {
            Object v = srcSlots[i];
            if (v == null) continue;
            if (v == org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject.LAZY)
            {
                v = pdoSrc.readSlot(i);
                if (v == null) continue;
            }
                                                          ...
                                                          TruffleMetadataAccess resolver)
    {
        ...
        if (typeArgs != null && typeArgs.size() > 0)
        {
            ...
            if (hasSelfRef)
            {
                ...
                Object cgtType = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(cgt, SLOT_TYPE);
                ...
                org.finos.legend.pure.truffle.types.ObjectSequence newArgs =
                        new org.finos.legend.pure.truffle.types.ObjectSequence(
                                java.util.Arrays.stream(typeArgs.toBoxedArray())
                                        .map(arg ->
                                        {
                                            ...
                                            if (arg != null)
                                            {
                                                ...
                                                if (argType != null && argType == original)
                                                {
                                                    ...
                                                    {
                                                        org.finos.legend.pure.truffle.runtime.helper._Any.write(selfRef, "typeArguments", innerTA);
                                                    }
                                                    Object innerMAObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(arg, SLOT_MULTIPLICITY_ARGUMENTS);
                                                    if (innerMAObj instanceof PureSequence innerMA && !innerMA.isEmpty())
                                                    {
                                                        org.finos.legend.pure.truffle.runtime.helper._Any.write(selfRef, "multiplicityArguments", innerMA);
                                                    }
                                        ...
                                        .toArray());
                org.finos.legend.pure.truffle.runtime.helper._Any.write(newCgt, "typeArguments", newArgs);
                Object mulArgsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(cgt, SLOT_MULTIPLICITY_ARGUMENTS);
                if (mulArgsObj != null)
                {
                    org.finos.legend.pure.truffle.runtime.helper._Any.write(newCgt, "multiplicityArguments", mulArgsObj);
                }
                return newCgt;
            }
        }
    ...
    private static void setDeepProperty(Object root, String dottedPath, Object value,
                                         org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode reader,
                                         org.finos.legend.pure.truffle.interpreter.ast.property.PropertyWriteNode writer)
    {
        ...
        for (int i = 0; i < parts.length - 1; i++)
        {
            ...
            Object childCopy = (child instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject)
                    ? CopySimpleNode.pdoCopyPublic(child) : null;
            if (childCopy != null)
            {
                Object cgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(child, SLOT_CLASSIFIER_GENERIC_TYPE);
                if (cgt != null)
                {
                    org.finos.legend.pure.truffle.runtime.helper._Any.write(childCopy, "classifierGenericType", cgt);
                }
                                                   ...
                                                   org.finos.legend.pure.truffle.PureContext eval)
    {
        ...
        Object cgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(copy, SLOT_CLASSIFIER_GENERIC_TYPE);
        if (cgt == null)
        {
            return;
        }
    ...
    private static void fixPropertyOwners(Object original, Object copy,
                                          TruffleMetadataAccess resolver)
    {
        Object propsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(copy, SLOT_PROPERTIES);
        ...
        Object copyGT = org.finos.legend.pure.truffle.runtime.helper._Any.isType(copy,
        ...
        for (int i = 0; i < props.size(); i++)
        {
            ...
            if (prop == null) continue;
            // Fix owner reference
            if (org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(prop, SLOT_OWNER) == original)
            {
                org.finos.legend.pure.truffle.runtime.helper._Any.write(prop, "owner", copy);
            }
            // Fix enum value CGT inside defaultValue lambda
            if (copyGT == null) continue;
            Object dv = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(prop, SLOT_DEFAULT_VALUE);
            if (dv == null) continue;
            Object dvExprObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(dv, SLOT_EXPRESSION_SEQUENCE);
            ...
            Object enumVal = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_VALUE);
            // Only PDOs carry an instance-level CGT — primitive defaults like
            // {@code Integer[1] = 1} have a Long value with no CGT to rewire.
            if (!(enumVal instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject)) continue;
            Object enumCgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(enumVal, SLOT_CLASSIFIER_GENERIC_TYPE);
            ...
            {
                org.finos.legend.pure.truffle.runtime.helper._Any.write(enumVal, "classifierGenericType", copyGT);
            }
        }
    }
    ...
    {
        Object typeParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(copy, SLOT_TYPE_PARAMETERS);
        if (typeParamsObj instanceof PureSequence typeParams)
        {
            for (int i = 0; i < typeParams.size(); i++)
            {
                ...
                if (tp != null)
                {
                    org.finos.legend.pure.truffle.runtime.helper._Any.write(tp, "owner", copy);
                }
            }
        }
        Object mulParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(copy, SLOT_MULTIPLICITY_PARAMETERS);
        if (mulParamsObj instanceof PureSequence mulParams)
        {
            for (int i = 0; i < mulParams.size(); i++)
            {
                ...
                if (mp != null)
                {
                    org.finos.legend.pure.truffle.runtime.helper._Any.write(mp, "owner", copy);
                }
            }
        }
    }
