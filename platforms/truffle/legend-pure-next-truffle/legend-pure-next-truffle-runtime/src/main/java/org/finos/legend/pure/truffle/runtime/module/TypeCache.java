 ...
 * </ul>
 *
 * <p>Lives on the {@link TruffleMetadataAccess
...
public final class TypeCache implements TruffleTypeCache
{
    ...
    private static final int SLOT_PROFILE = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("profile");
    private static final int SLOT_STEREOTYPES = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("stereotypes");
    ...
    private static final int SLOT_GENERAL =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("general");
    private static final int SLOT_GENERALIZATIONS =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("generalizations");
    private static final int SLOT_NAME =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("name");
    private static final int SLOT_PROPERTIES =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("properties");
    ...
    @Override
    @com.oracle.truffle.api.CompilerDirectives.TruffleBoundary
    public Set<Object> ancestors(Object type, TruffleMetadataAccess resolver)
    {
        return entryFor(type, resolver).ancestors;
    }

    private Entry entryFor(Object type, TruffleMetadataAccess resolver)
    {
        if (type == null)
        {
            return EMPTY;
    ...
    private synchronized Entry computeAndCache(Object t, TruffleMetadataAccess resolver)
    {
    ...
    private static Entry compute(Object type, TruffleMetadataAccess resolverOrNull)
    {
    ...
    private static boolean hasEqualityKeyStereotype(Object prop, TruffleMetadataAccess resolver)
    {
