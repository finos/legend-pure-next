...
public final class _PackageableElement
{
    ...
    private static final int SLOT_POINTER_PATH =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("path");
    ...
    public static String pointerPath(Object v)
    {
        ...
        String typePath = _Any.pureTypeOf(v);
        if (typePath == null || !typePath.startsWith(POINTER_TYPE_PREFIX)) return null;
        Object slotPath = _Any.readBySlot(v, SLOT_POINTER_PATH);
    ...
    {
        return obj instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdo
                ? pdo.readSlot(SLOT_PACKAGE)
                : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(obj, SLOT_PACKAGE);
    }
    ...
    private static Object readName(Object obj)
    {
        return obj instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdo
                ...
                : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(obj, SLOT_NAME);
    }
    ...
    private static String packagePath(Object pkg)
    {
        ...
        int depth = 0;
        while (current != null
                && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(current, PACKAGE_PURE_PATH)
                && depth < 15)
        {
