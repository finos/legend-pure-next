...
public final class MultiIfNode extends PureNode
{
    ...
    private Object runtimeLoop(Object condList, Object defaultFn)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            Object condFn = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(item, SLOT_FIRST);
            Object condResult = condCallNode.call(condFn);
            if (Boolean.TRUE.equals(condResult))
            {
                Object bodyFn = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(item, SLOT_SECOND);
