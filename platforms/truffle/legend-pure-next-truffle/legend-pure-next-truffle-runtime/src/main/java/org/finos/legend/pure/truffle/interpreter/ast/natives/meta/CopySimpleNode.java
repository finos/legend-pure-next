...
public final class CopySimpleNode extends PureNode
{
    ...
    private static final int SLOT_TYPE_ARGUMENTS = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("typeArguments");
    @Child
    ...
    private static Object doCopy(Object original, TruffleMetadataAccess resolver)
    {
        if (original == null)
        {
        ...
        if (cgt != null)
        {
            org.finos.legend.pure.truffle.runtime.helper._Any.write(copy, "classifierGenericType",
    ...
    {
        org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject src =
                (org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject) original;
        ...
        {
            if (src.slots[i] == org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject.LAZY)
            {
                src.readSlot(i);
            }
        }
    ...
    {
        if (org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(gtv, SLOT_TYPE) == original) return true;
        Object taObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(gtv, SLOT_TYPE_ARGUMENTS);
                                                ...
                                                TruffleMetadataAccess resolver)
    {
        ...
        Object type = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(gtv, SLOT_TYPE);
        if (type == original && copy != null)
        {
            org.finos.legend.pure.truffle.runtime.helper._Any.write(result, "type", copy);
        }
        else if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(type,
                "meta::pure::metamodel::type::generics::TypeParameter")
                && org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_OWNER) == original)
        {
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(tpCopy, "owner", copy);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(result, "type", tpCopy);
        }
        else
        {
            org.finos.legend.pure.truffle.runtime.helper._Any.write(result, "type", type);
        }
        ...
        if (taObj instanceof org.finos.legend.pure.truffle.types.PureSequence typeArgs && !typeArgs.isEmpty())
        {
            ...
            for (int i = 0; i < typeArgs.size(); i++)
            {
                ...
                if (ta != null && org.finos.legend.pure.truffle.runtime.helper._Any.isType(ta,
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(result, "typeArguments",
