...
public final class EvalNode extends PureNode
{
                                    ...
                                    org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode propertyReader)
    {
        ...
        if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(fn,
                ...
                "meta::pure::metamodel::function::property::Property"))
        {
            if (args.length > 0)
            {
                return propertyReader.execute(args[0],
                        (String) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fn, SLOT_NAME));
            }
            return org.finos.legend.pure.truffle.types.PureSequence.EMPTY;
        }
        TruffleMetadataAccess resolver = evaluator.resolver();
        if (org.finos.legend.pure.truffle.runtime.helper._Any.isType(fn,
    ...
    {
        String signature = (String) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(nf, SLOT_NAME);
