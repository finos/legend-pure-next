...
@NodeInfo(shortName = "containsStr")
public final class ContainsStringNode extends PureNode
{
    private static final String SIG = "contains_String_1__String_1__Boolean_1_";
    ...
    public ContainsStringNode(PureNode strArg, PureNode searchArg)
    {
        this.strArg = strArg;
