...
public final class GenericTypeHolderNode extends PureNode
{
    ...
    private static Object doGenericTypeHolder(Object result, Object genericType, Object multiplicity, TruffleMetadataAccess resolver)
    {
        ...
        if (heldGT != null)
        {
            org.finos.legend.pure.truffle.runtime.helper._Any.write(classifierGT, "typeArguments",
        ...
        org.finos.legend.pure.truffle.runtime.helper._Any.write(holder, "classifierGenericType", classifierGT);
        org.finos.legend.pure.truffle.runtime.helper._Any.write(holder, "genericType", classifierGT);
        org.finos.legend.pure.truffle.runtime.helper._Any.write(holder, "multiplicity",
