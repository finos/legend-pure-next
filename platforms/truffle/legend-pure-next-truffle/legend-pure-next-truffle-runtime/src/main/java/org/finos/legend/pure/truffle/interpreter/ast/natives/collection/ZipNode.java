...
public final class ZipNode extends PureNode
{
    ...
    private static Object doZip(Object left, Object right, int sz, Object pairCGT, TruffleMetadataAccess resolver)
    {
        ...
        for (int i = 0; i < sz; i++)
        {
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(pair, "first", CollectionHelper.at(left, i));
            org.finos.legend.pure.truffle.runtime.helper._Any.write(pair, "second", CollectionHelper.at(right, i));
            org.finos.legend.pure.truffle.runtime.helper._Any.write(pair, "classifierGenericType", pairCGT);
            pairs[i] = pair;
        }
