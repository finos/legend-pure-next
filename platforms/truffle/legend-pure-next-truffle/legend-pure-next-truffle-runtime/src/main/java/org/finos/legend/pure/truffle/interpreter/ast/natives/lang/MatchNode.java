...
package org.finos.legend.pure.truffle.interpreter.ast.natives.lang;
...
public final class MatchNode extends PureNode
{
    ...
    private static Object invokeMatch(Object[] values, org.finos.legend.pure.truffle.PureContext context, RawLambdaCallNode matchCallNode)
    {
        ...
        for (int i = 0; i < fnCount; i++)
        {
            ...
            else
            {
                ...
                if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(mfRaw,
                        "meta::pure::metamodel::valuespecification::AtomicValue"))
                {
                    Object inner = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mfRaw, SLOT_VALUE);
                    if (inner != null)
                    {
                        mfRaw = inner;
                    }
                ...
                else if (org.finos.legend.pure.truffle.runtime.helper._Any.isType(mfRaw,
            ...
            Object[] args;
            Object fdParams = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fd, SLOT_PARAMETERS);
            if (values.length > 2
        ...
        for (int di = 0; di < fnCount; di++)
        {
            ...
            if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(mfRawD,
                    "meta::pure::metamodel::valuespecification::AtomicValue"))
            {
                Object inner = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mfRawD, SLOT_VALUE);
                if (inner != null) mfRawD = inner;
            }
            Object fdD = mfRawD instanceof RawClosure rcD ? rcD.lambda() : mfRawD;
            Object pParams = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fdD, SLOT_PARAMETERS);
            ...
            if (pParams instanceof org.finos.legend.pure.truffle.types.PureSequence ps && !ps.isEmpty())
            {
                ...
                Object lb = mul != null ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mul, SLOT_LOWER_BOUND) : null;
                Object ub = mul != null ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mul, SLOT_UPPER_BOUND) : null;
                Object lbV = lb != null ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lb, SLOT_VALUE) : null;
                Object ubV = ub != null ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(ub, SLOT_VALUE) : null;
    ...
    {
        return org.finos.legend.pure.truffle.interpreter.ast.natives.meta.MetaHelper.getRawValueType(value, context.resolver());
    }

    private static final int SLOT_PARAMETERS =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("parameters");
    private static final int SLOT_MULTIPLICITY =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("multiplicity");
    ...
    {
        Object paramsObj = fd instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject fdPdo
                ? fdPdo.readSlot(SLOT_PARAMETERS)
                : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fd, SLOT_PARAMETERS);
        ...
        if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(param,
                "meta::pure::metamodel::valuespecification::VariableExpression"))
        {
            throw new RuntimeException("Error");
        }

        Object paramMul = param instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pPdo
                ? pPdo.readSlot(SLOT_MULTIPLICITY)
                : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(param, SLOT_MULTIPLICITY);
        ...
        Object paramGT = param instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pPdo2
                ? pPdo2.readSlot(SLOT_GENERIC_TYPE)
                : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(param, SLOT_GENERIC_TYPE);
        if (paramGT != null)
        {
    ...
    private static boolean multiplicityAccepts(Object mult, int count)
    {
        ...
        boolean multIsPdo = mult instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject;
        Object lb = multIsPdo
                ? ((org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject) mult).readSlot(SLOT_LOWER_BOUND)
                : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mult, SLOT_LOWER_BOUND);
        Object ub = multIsPdo
                ? ((org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject) mult).readSlot(SLOT_UPPER_BOUND)
                : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mult, SLOT_UPPER_BOUND);
        if (lb == null && ub == null)
        {
            return true;
        }
        ...
        if (lb != null)
        {
            Object v = lb instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject lbPdo
                    ? lbPdo.readSlot(SLOT_VALUE)
                    : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lb, SLOT_VALUE);
        ...
        if (ub != null)
        {
            Object v = ub instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject ubPdo
                    ? ubPdo.readSlot(SLOT_VALUE)
                    : org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(ub, SLOT_VALUE);
