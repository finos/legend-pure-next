...
package org.finos.legend.pure.truffle.cli;
...
public final class PureCompileMain
{
    ...
    private static void compile(String[] args) throws Exception
    {
        ...
        org.finos.legend.pure.truffle.compile.TruffleCompilerBinaryBuilder.compile(
    ...
    private static void execute(String[] args) throws Exception
    {
        ...
        java.util.List<TrufflePdbLoader> loaders = new java.util.ArrayList<>();
        TruffleModuleRegistry resolver =
                new TruffleModuleRegistry();
        for (String p : pdbPaths)
        {
            TrufflePdbLoader loader =
                    new TrufflePdbLoader(
     ...
     * See {@link org.finos.legend.pure.truffle.compile.TruffleFromMemoryRunner}.</p>
     */
    private static void executeFromMemory(String[] args) throws Exception
    {
        ...
        {
            TrufflePdbLoader loader =
                    new TrufflePdbLoader(Path.of(p));
            resolver.register(loader);
            loaders.add(loader);
        }
        for (var loader : loaders) loader.setResolver(resolver);
        ...
        try
        {
            ...
            org.finos.legend.pure.truffle.compile.TruffleFromMemoryRunner.compileAndRegister(
