...
import org.finos.legend.pure.truffle.interpreter.ast.call.RawLambdaCallNode;
...
public final class NewWithKeysNode extends PureNode
{
    ...
    private static final int SLOT_EXPRESSION = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("expression");
    ...
    @Child
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyWriteNode dynamicKeyWriter = new org.finos.legend.pure.truffle.interpreter.ast.property.PropertyWriteNode();
    ...
    public NewWithKeysNode(String signature, PureNode typeHolderNode, org.finos.legend.pure.truffle.interpreter.ast.property.PropertyAssignNode[] assignments)
    {
        this(signature, typeHolderNode, assignments, null);
    }

    public NewWithKeysNode(String signature, PureNode typeHolderNode, org.finos.legend.pure.truffle.interpreter.ast.property.PropertyAssignNode[] assignments, PureNode keysNode)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < assignments.length; i++)
            {
                if ("classifierGenericType".equals(assignments[i].propertyName()))
                {
                    ...
                    if (propValue != null)
                    {
                        org.finos.legend.pure.truffle.runtime.helper._Any.write(instance, "classifierGenericType", propValue);
                    }
                    continue;
                }
    ...
    private Object[] createAndInitInstance(Object typeHolder, org.finos.legend.pure.truffle.PureContext eval)
    {
        ...
        if (typeHolder != null)
        {
            Object holderGT = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(typeHolder, SLOT_GENERIC_TYPE);
            if (holderGT != null)
            {
                hoistedGt = holderGT;
        ...
        if (hoistedGt != null && instance != null)
        {
            ...
            if (typeArgs != null && typeArgs.size() > 0)
            {
                ...
                if (org.finos.legend.pure.truffle.runtime.helper._Any.isType(firstArg,
                        "meta::pure::metamodel::type::generics::GenericTypeValue", eval.resolver()))
                {
                    ...
                    org.finos.legend.pure.truffle.runtime.helper._Any.write(instance, "classifierGenericType", resolved);
                }
            }
            else if (!"Unknown".equals(classPath))
            {
                ...
                if (typeElement != null)
                {
                    org.finos.legend.pure.truffle.runtime.helper._Any.write(instance, "classifierGenericType",
        ...
        if (instance != null
                && org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(instance, SLOT_CLASSIFIER_GENERIC_TYPE) == null)
        {
            Object hgt = typeHolder != null
                    ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(typeHolder, SLOT_GENERIC_TYPE) : null;
                                   ...
                                   org.finos.legend.pure.truffle.PureContext eval)
    {
        ...
        if (instance != null)
        {
            Object cgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(instance, SLOT_CLASSIFIER_GENERIC_TYPE);
            if (cgt != null)
            {
                                            ...
                                            java.util.List<java.util.Map.Entry<String, Object>> keyValues)
    {
        ...
        int len = org.finos.legend.pure.truffle.interpreter.ast.natives.collection.CollectionHelper.size(keys);
        for (int i = 0; i < len; i++)
        {
            Object item = org.finos.legend.pure.truffle.interpreter.ast.natives.collection.CollectionHelper.at(keys, i);
            if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(item,
            ...
            Object propNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(item, SLOT_NAME);
            if (!(propNameObj instanceof String propName))
            {
                throw new RuntimeException("KeyExpression at index " + i + " has no name");
            }
            Object value = unwrapSingleton(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(item, SLOT_EXPRESSION));
     ...
     */
    private static void validateClassifierOverride(Object proposed, Object instance, TruffleMetadataAccess resolver)
    {
    ...
    private static boolean samePackageableElement(Object a, Object b, TruffleMetadataAccess resolver)
    {
        if (a == b)
        {
            return true;
     ...
     */
    private static boolean isSubtypeViaGeneralizations(Object sub, Object sup, TruffleMetadataAccess resolver)
    {
        ...
        for (int depth = 0; depth < 32 && current != null; depth++)
        {
            ...
            Object gens = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(current, SLOT_GENERALIZATIONS);
            if (!(gens instanceof PureSequence seq) || seq.size() == 0) return false;
            Object next = null;
            for (int i = 0; i < seq.size(); i++)
            {
                Object g = seq.getBoxed(i);
                Object generalGT = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(g, SLOT_GENERAL);
            ...
            TruffleMetadataAccess resolver)
    {
        ...
        Object mulArgs = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(gtv, SLOT_MULTIPLICITY_ARGUMENTS);
     ...
     * {@link TruffleModuleRegistry#reverseAssociationCandidates}.
                                          ...
                                          org.finos.legend.pure.truffle.interpreter.ast.property.PropertyWriteNode writer)
    {
        ...
        try
        {
            ...
            if (target instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdo)
            {
