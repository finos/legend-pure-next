...
package org.finos.legend.pure.truffle.interpreter;

import org.finos.legend.pure.truffle.interpreter.ast.variable.FrameLetFunctionNode;
...
import org.finos.legend.pure.truffle.interpreter.ast.variable.FrameVariableReadNode;
import org.finos.legend.pure.truffle.interpreter.ast.PureNode;
import org.finos.legend.pure.truffle.interpreter.ast.literal.RawCollectionNode;
import org.finos.legend.pure.truffle.interpreter.ast.variable.RawLambdaCaptureNode;
import org.finos.legend.pure.truffle.interpreter.ast.property.RawPropertyAccessNode;
import org.finos.legend.pure.truffle.interpreter.ast.call.RawUserFunctionCallNode;
import org.finos.legend.pure.truffle.interpreter.ast.root.FrameLayout;
...
public final class PureASTBuilder
{
    ...
    private static final int SLOT_EXPRESSION_SEQUENCE = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("expressionSequence");
    private static final int SLOT_FUNC = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("func");
    private static final int SLOT_FUNCTION_NAME = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("functionName");
    private static final int SLOT_GENERIC_TYPE = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("genericType");
    private static final int SLOT_MULTIPLICITY = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("multiplicity");
    private static final int SLOT_NAME = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("name");
    private static final int SLOT_OPEN_VARIABLES = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("openVariables");
    private static final int SLOT_OWNER = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("owner");
    private static final int SLOT_PARAMETERS = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("parameters");
    private static final int SLOT_PARAMETERS_VALUES = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("parametersValues");
    private static final int SLOT_QUALIFIED_PROPERTIES = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("qualifiedProperties");
    private static final int SLOT_VALUE = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("value");
    private static final int SLOT_VALUES = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("values");
    private static final int SLOT_LOWER_BOUND = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("lowerBound");
    private static final int SLOT_UPPER_BOUND = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("upperBound");
     ...
     * {@link org.finos.legend.pure.truffle.runtime.helper._Any#isType}
     * handles {@link org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject}
    ...
    private PureNode lowerImpl(Object vs)
    {
        ...
        if (org.finos.legend.pure.truffle.runtime.helper._Any.isType(vs,
    ...
    {
        Object valuesObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(col, SLOT_VALUES);
     ...
     * org.finos.legend.pure.truffle.interpreter.ast.property.DirectPropertyAccessNode} which
    ...
    private PureNode lowerPropertyAccess(Object prop, Object fe)
    {
        ...
        Object propName = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(prop, SLOT_NAME);
        boolean isQp = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(prop,
        ...
        {
            return new org.finos.legend.pure.truffle.interpreter.ast.property.DirectPropertyAccessNode(args[0], name);
        }
    ...
    {
        Object owner = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(prop, SLOT_OWNER);
        ...
        return org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(owner,
    ...
    private PureNode lowerFunctionExpression(Object fe)
    {
        ...
        if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(fe,
                "meta::pure::metamodel::valuespecification::DotApplication"))
        {
            Object fnNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_FUNCTION_NAME);
            if ("~".equals(fnNameObj))
            {
                int depth = countParentReferenceChainDepth(fe);
                StringBuilder sb = new StringBuilder("~");
                for (int i = 1; i < depth; i++) sb.append(".~");
                return new org.finos.legend.pure.truffle.interpreter.ast.variable.ParentReferenceReadNode(depth - 1, sb.toString());
            }
        }
        Object funcObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_FUNC);
        if (funcObj == null)
        {
            ...
            Object funcByName = org.finos.legend.pure.truffle.runtime.helper._Any.read(fe, "func");
            Object fnNameDbg = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_FUNCTION_NAME);
            if (fnNameDbg == null)
            {
                fnNameDbg = org.finos.legend.pure.truffle.runtime.helper._Any.read(fe, "functionName");
            }
            ...
            Object srcInfo = org.finos.legend.pure.truffle.runtime.helper._Any.read(fe, "sourceInformation");
            String srcStr;
            if (srcInfo == null)
            {
                srcStr = "null";
            ...
            {
                Object sid = org.finos.legend.pure.truffle.runtime.helper._Any.read(srcInfo, "sourceId");
                Object sl = org.finos.legend.pure.truffle.runtime.helper._Any.read(srcInfo, "startLine");
                Object sc = org.finos.legend.pure.truffle.runtime.helper._Any.read(srcInfo, "startColumn");
                Object el = org.finos.legend.pure.truffle.runtime.helper._Any.read(srcInfo, "endLine");
                Object ec = org.finos.legend.pure.truffle.runtime.helper._Any.read(srcInfo, "endColumn");
            ...
            {
                String t = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(cur);
                Object nm = org.finos.legend.pure.truffle.runtime.helper._Any.read(cur, "name");
                Object fn = org.finos.legend.pure.truffle.runtime.helper._Any.read(cur, "functionName");
                parents.append("\n      ").append(depth).append(": ")
                        .append(t == null ? cur.getClass().getName() : t)
                        .append(" name=").append(nm)
                        .append(" functionName=").append(fn);
                Object next = cur instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdo ? pdo.parent : null;
                if (next == null)
                {
                    next = org.finos.legend.pure.truffle.runtime.helper._Any.read(cur, "owner");
                }
                cur = next;
                depth++;
            }
            ...
            if (fe instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdo)
            {
                ...
                for (int s = 0; s < names.length; s++)
                {
                    ...
                    else if (v instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject vp) vs = vp.classInfo.purePath + "@" + System.identityHashCode(vp);
            ...
            try
            {
                ...
                if (regField != null)
                {
                    ...
                    Object cs = org.finos.legend.pure.truffle.runtime.helper._Any.read(regField, "constraints");
                    if (cs instanceof org.finos.legend.pure.truffle.types.PureSequence csSeq && csSeq.size() > 0)
                    {
                        ...
                        Object lam = org.finos.legend.pure.truffle.runtime.helper._Any.read(c0, "functionDefinition");
                        registryView.append("\n  registry .functionDefinition@").append(System.identityHashCode(lam));
                        Object es = org.finos.legend.pure.truffle.runtime.helper._Any.read(lam, "expressionSequence");
                        if (es instanceof org.finos.legend.pure.truffle.types.PureSequence esSeq && esSeq.size() > 0)
                        {
                            Object regFe = esSeq.getBoxed(0);
                            Object regFunc = org.finos.legend.pure.truffle.runtime.helper._Any.read(regFe, "func");
                            registryView.append("\n  registry .expressionSequence[0]@").append(System.identityHashCode(regFe))
                                    .append(" func=").append(regFunc == null ? "null" : org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(regFunc));
        ...
        if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(func,
                "meta::pure::metamodel::function::property::QualifiedProperty"))
        {
            Object feParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_PARAMETERS_VALUES);
            int callArgCount = feParamsObj instanceof PureSequence feps ? feps.size() : 0;
            Object qpParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(func, SLOT_PARAMETERS);
        ...
        if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(resolvedFunc,
        ...
        TruffleMetadataAccess resolver =
                org.finos.legend.pure.truffle.PureLanguage.get(null).resolver();
        if (org.finos.legend.pure.truffle.runtime.helper._Any.isType(resolvedFunc,
        ...
        String pureType = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(resolvedFunc);
        throw new RuntimeException(
                "Unsupported function type: " + (pureType != null ? pureType : resolvedFunc.getClass().getName())
                        + " for: " + org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_FUNCTION_NAME));
    }

    /**
     * Try to lower a call to {@code if(Pair<...>[*], Function[1])} into a
     * {@link org.finos.legend.pure.truffle.interpreter.ast.natives.lang.MultiIfNode}.
     *
     ...
     * {@link org.finos.legend.pure.truffle.interpreter.ast.natives.lang.LambdaCallNoArgNode}.
     * Either way the {@code pair()} call site is bypassed entirely.</p>
     */
    public PureNode tryLowerMultiIf(Object fe)
    {
        Object paramsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_PARAMETERS_VALUES);
        if (!(paramsObj instanceof PureSequence params) || params.size() < 2)
        {
            return null;
        }
        Object pairsArg = params.getBoxed(0);
        if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(pairsArg,
                "meta::pure::metamodel::valuespecification::Collection"))
        {
            return null;
        }
        Object pairValuesObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(pairsArg, SLOT_VALUES);
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (!org.finos.legend.pure.truffle.runtime.helper._Any.isType(pairFe,
                    "meta::pure::metamodel::valuespecification::FunctionExpression",
                    org.finos.legend.pure.truffle.PureLanguage.get(null).resolver()))
            {
                return null;
            }
            Object pairFunc = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(pairFe, SLOT_FUNC);
            if (!org.finos.legend.pure.truffle.runtime.helper._Any.isType(pairFunc,
                    "meta::pure::metamodel::function::FunctionDefinition",
                    org.finos.legend.pure.truffle.PureLanguage.get(null).resolver())
                    || !PAIR_SIGNATURE.equals(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(pairFunc, SLOT_NAME)))
            {
                return null;
            }
            Object pairArgsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(pairFe, SLOT_PARAMETERS_VALUES);
        ...
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.lang.MultiIfNode(conds, bodies, defaultBody);
    }

    /**
     * Try to lower a call to {@code if(Boolean[1], Function<{->T[m]}>[1], Function<{->T[m]}>[1])}
     * — the plain 3-arg if — into a static-mode {@link org.finos.legend.pure.truffle.interpreter.ast.natives.lang.IfNode}
    ...
    public PureNode tryLowerIf(Object fe)
    {
        ...
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.lang.IfNode(
     ...
     * {@link org.finos.legend.pure.truffle.interpreter.ast.natives.lang.SpecializedMatchNode}.
     *
    ...
    public PureNode tryLowerMatch(Object fe)
    {
        ...
        if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(branchListVs,
                "meta::pure::metamodel::valuespecification::Collection"))
        {
            return null;
        }
        Object branchValuesObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(branchListVs, SLOT_VALUES);
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(branchVs,
                    "meta::pure::metamodel::valuespecification::AtomicValue"))
            {
                return null;
            }
            Object lambda = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(branchVs, SLOT_VALUE);
            if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(lambda,
                    "meta::pure::metamodel::function::LambdaFunction"))
            {
                return null;
            }
            // Single parameter, multiplicity [1], known concrete type.
            Object lambdaParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambda, SLOT_PARAMETERS);
            if (!(lambdaParamsObj instanceof PureSequence lambdaParams) || lambdaParams.size() != 1)
            {
                return null;
            }
            Object param = lambdaParams.getBoxed(0);
            Object paramGT = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(param, SLOT_GENERIC_TYPE);
            if (paramGT == null)
            {
                return null;
            }
            ...
            Object paramMul = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(param, SLOT_MULTIPLICITY);
        ...
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.lang.SpecializedMatchNode(
    ...
    private static boolean isSingleMultiplicity(Object mul)
    {
        ...
        Object lb = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mul, SLOT_LOWER_BOUND);
        Object ub = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mul, SLOT_UPPER_BOUND);
        if (lb == null || ub == null) return false;
        Object lbVal = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lb, SLOT_VALUE);
        Object ubVal = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(ub, SLOT_VALUE);
     ...
     *       wrapped in a {@link org.finos.legend.pure.truffle.interpreter.ast.natives.lang.LambdaCallNoArgNode}
    ...
    {
        Object inner = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(vs,
                "meta::pure::metamodel::valuespecification::AtomicValue")
                ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_VALUE) : null;
        // Widened from `instanceof LambdaFunction` so PDO lambdas
        // (post-loader-flip resolver returns) take the same fast path.
        if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(inner,
                "meta::pure::metamodel::function::LambdaFunction"))
        {
            Object lfParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(inner, SLOT_PARAMETERS);
            if (!(lfParamsObj instanceof PureSequence lfParams) || lfParams.isEmpty())
            {
                Object bodyObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(inner, SLOT_EXPRESSION_SEQUENCE);
        ...
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.lang.LambdaCallNoArgNode(lowered);
    }
     ...
     *  caller's {@link org.finos.legend.pure.truffle.interpreter.FrameDescriptorBuilder}
    ...
    {
        if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(vs,
                "meta::pure::metamodel::valuespecification::FunctionInvocation")
                && !org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(vs,
                        "meta::pure::metamodel::valuespecification::DotApplication")
                && !org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(vs,
        ...
        Object funcName = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_FUNCTION_NAME);
        if ("letFunction".equals(funcName)) return true;
        Object func = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_FUNC);
        return func != null
                && LET_FUNCTION_SIGNATURE.equals(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(func, SLOT_NAME));
    }
    ...
    {
        Object owner = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(wrongQp, SLOT_OWNER);
        if (owner == null) return null;
        Object qpsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(owner, SLOT_QUALIFIED_PROPERTIES);
        if (!(qpsObj instanceof PureSequence qps)) return null;
        Object targetNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(wrongQp, SLOT_NAME);
        if (!(targetNameObj instanceof String targetName)) return null;
        for (int i = 0; i < qps.size(); i++)
        {
            Object candidate = qps.getBoxed(i);
            if (candidate == null) continue;
            Object cqpName = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(candidate, SLOT_NAME);
            if (!targetName.equals(cqpName)) continue;
            Object cqpParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(candidate, SLOT_PARAMETERS);
            if (cqpParamsObj instanceof PureSequence cqpParams
                    && cqpParams.size() == expectedParamCount
                    && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(candidate,
                            "meta::pure::metamodel::function::property::QualifiedProperty"))
            {
                return candidate;
            }
    ...
    {
        Object sigObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(nf, SLOT_NAME);
        ...
        if (factory != null)
        {
            Object gt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_GENERIC_TYPE);
            Object mul = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_MULTIPLICITY);
     ...
     * pre-allocated by {@link org.finos.legend.pure.truffle.interpreter.FrameDescriptorBuilder}.
    ...
    {
        Object argsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_PARAMETERS_VALUES);
        if (!(argsObj instanceof PureSequence args) || args.size() <= lambdaArgIdx) return null;
        Object lambdaArg = args.getBoxed(lambdaArgIdx);
        if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(lambdaArg,
                "meta::pure::metamodel::valuespecification::AtomicValue")) return null;
        Object lambda = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambdaArg, SLOT_VALUE);
        if (!org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(lambda,
                "meta::pure::metamodel::function::LambdaFunction")) return null;

        org.finos.legend.pure.truffle.interpreter.ast.root.CompiledFunction cf =
                org.finos.legend.pure.truffle.PureLanguage.get(null).compileLambdaFunction(lambda);
        if (cf == null) return null;
        PureNode[] body = cf.body();
        if (body == null) return null;
        org.finos.legend.pure.truffle.interpreter.ast.root.FrameLayout lambdaLayout = cf.layout();

        Object openVarsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambda, SLOT_OPEN_VARIABLES);
        ...
        if (n > 0)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                Object nm = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(o, SLOT_NAME);
    ...
    private record InlineSubframeMeta(PureSequence callArgs, PureNode[] body,
            org.finos.legend.pure.truffle.interpreter.ast.root.FrameLayout lambdaLayout,
    ...
    private PureNode lowerInlineExists(Object fe, boolean forAll)
    {
        ...
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.collection.InlineExistsNode(
    ...
    private PureNode lowerInlineFold(Object fe)
    {
        ...
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.collection.InlineFoldNode(
    ...
    private PureNode lowerInlineMap(Object fe)
    {
        ...
        if (m == null) return null;
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.collection.InlineMapNode(
    ...
    private PureNode lowerInlineFilter(Object fe)
    {
        InlineSingleArgMeta m = resolveInlineSingleArg(fe);
        if (m == null) return null;
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.collection.InlineFilterNode(
                m.collection, m.body, m.lambdaDescriptor, m.elemSlot,
                m.callerSlots, m.lambdaSlots);
    }
    ...
    private PureNode lowerInlineFind(Object fe)
    {
        InlineSingleArgMeta m = resolveInlineSingleArg(fe);
        if (m == null) return null;
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.collection.InlineFindNode(
                m.collection, m.body, m.lambdaDescriptor, m.elemSlot,
                m.callerSlots, m.lambdaSlots);
    }
    ...
    private PureNode lowerInlineGroupBy(Object fe)
    {
        InlineSingleArgMeta m = resolveInlineSingleArg(fe);
        if (m == null) return null;
        return new org.finos.legend.pure.truffle.interpreter.ast.natives.collection.InlineGroupByNode(
                m.collection, m.body, m.lambdaDescriptor, m.elemSlot,
                m.callerSlots, m.lambdaSlots);
    }
    ...
    {
        Object nameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(ve, SLOT_NAME);
        ...
        if (tildeDepth > 0)
        {
            return new org.finos.legend.pure.truffle.interpreter.ast.variable.ParentReferenceReadNode(tildeDepth - 1, veName);
        }
    ...
    private static int countParentReferenceChainDepth(Object root)
    {
        ...
        Object cur = root;
        while (cur != null
                && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(cur,
                        "meta::pure::metamodel::valuespecification::DotApplication")
                && "~".equals(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(cur, SLOT_FUNCTION_NAME)))
        {
            depth++;
            Object paramsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(cur, SLOT_PARAMETERS_VALUES);
        ...
        if (cur != null
                ...
                && "~".equals(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(cur, SLOT_NAME)))
        {
            return depth + 1;
        }
        return -1;
    ...
    private PureNode lowerFrameLet(Object fe)
    {
        ...
        Object nameInner = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(nameArg,
                "meta::pure::metamodel::valuespecification::AtomicValue")
                ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(nameArg, SLOT_VALUE) : null;
    ...
    {
        Object value = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(av, SLOT_VALUE);
        // Widened from `instanceof LambdaFunction` so PDO lambdas
        // (post-loader-flip resolver returns) take the same path.
        if (value != null && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(value,
                "meta::pure::metamodel::function::LambdaFunction"))
        {
            Object openVarsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(value, SLOT_OPEN_VARIABLES);
        ...
        {
            return new org.finos.legend.pure.truffle.interpreter.ast.literal.LongConstantNode(l);
        }
        if (value instanceof Double d)
        {
            return new org.finos.legend.pure.truffle.interpreter.ast.literal.DoubleConstantNode(d);
        }
        if (value instanceof Boolean b)
        {
            return new org.finos.legend.pure.truffle.interpreter.ast.literal.BooleanConstantNode(b);
        }
    ...
    private static String extractTypeName(Object av)
    {
        try
        {
            Object gt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(av, SLOT_GENERIC_TYPE);
            if (gt == null)
            {
                return null;
            }
            ...
            if (type != null)
            {
                Object n = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_NAME);
    ...
    {
        Object paramSpecsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_PARAMETERS_VALUES);
