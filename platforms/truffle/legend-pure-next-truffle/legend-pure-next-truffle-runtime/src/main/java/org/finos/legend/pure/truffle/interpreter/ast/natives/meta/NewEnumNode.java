...
public final class NewEnumNode extends PureNode
{
    ...
    private static Object doNewEnumeration(Object name, Object pkg, Object valueNames, TruffleMetadataAccess resolver)
    {
        ...
        org.finos.legend.pure.truffle.runtime.helper._Any.write(enumeration, "name",
                name instanceof String s ? s : String.valueOf(name));
        if (pkg != null)
        {
            org.finos.legend.pure.truffle.runtime.helper._Any.write(enumeration, "package", pkg);
        }
        ...
        if (enumTypeObj != null)
        {
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(gen, "general",
                    _GenericType.buildUserDefinedGenericType(enumTypeObj, resolver));
            org.finos.legend.pure.truffle.runtime.helper._Any.write(gen, "specific", enumeration);
            Object genTypeObj = resolver.getElement("meta::pure::metamodel::relationship::Generalization");
            if (genTypeObj != null)
            {
                org.finos.legend.pure.truffle.runtime.helper._Any.write(gen, "classifierGenericType",
                        _GenericType.buildUserDefinedGenericType(genTypeObj, resolver));
            }
            org.finos.legend.pure.truffle.runtime.helper._Any.write(enumeration, "generalizations",
        ...
        org.finos.legend.pure.truffle.runtime.helper._Any.write(cgt, "typeArguments",
                new ObjectSequence(new Object[]{selfRef}));
        org.finos.legend.pure.truffle.runtime.helper._Any.write(enumeration, "classifierGenericType", cgt);
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(enumInstance, "name", valueName);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(enumInstance, "classifierGenericType", enumGT);
            ...
            {
                org.finos.legend.pure.truffle.runtime.helper._Any.write(ft, "classifierGenericType",
                        _GenericType.buildUserDefinedGenericType(functionTypeTypeObj, resolver));
            }
            org.finos.legend.pure.truffle.runtime.helper._Any.write(ft, "returnType", enumGT);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(ft, "returnMultiplicity", pureOne);
            ...
            if (igtType != null)
            {
                org.finos.legend.pure.truffle.runtime.helper._Any.write(ftGT, "classifierGenericType",
                        _GenericType.buildUserDefinedGenericType(igtType, resolver));
            }
            org.finos.legend.pure.truffle.runtime.helper._Any.write(ftGT, "type", ft);
            Object lambdaCGT = org.finos.legend.pure.truffle.runtime.TruffleInstanceFactory.createInstance(
                    "meta::pure::metamodel::type::generics::InferredGenericType", resolver);
            if (igtType != null)
            {
                org.finos.legend.pure.truffle.runtime.helper._Any.write(lambdaCGT, "classifierGenericType",
                        _GenericType.buildUserDefinedGenericType(igtType, resolver));
            }
            org.finos.legend.pure.truffle.runtime.helper._Any.write(lambdaCGT, "type", lambdaFunctionTypeObj);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(lambdaCGT, "typeArguments",
            ...
            if (avType != null)
            {
                org.finos.legend.pure.truffle.runtime.helper._Any.write(atomicValue, "classifierGenericType",
                        _GenericType.buildUserDefinedGenericType(avType, resolver));
            }
            org.finos.legend.pure.truffle.runtime.helper._Any.write(atomicValue, "value", enumInstance);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(atomicValue, "genericType", enumGT);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(atomicValue, "multiplicity", pureOne);
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(lambda, "classifierGenericType", lambdaCGT);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(lambda, "expressionSequence",
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(propCGT, "typeArguments",
                    new ObjectSequence(new Object[]{cgt, enumGT}));
            org.finos.legend.pure.truffle.runtime.helper._Any.write(propCGT, "multiplicityArguments",
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(prop, "name", valueName);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(prop, "classifierGenericType", propCGT);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(prop, "genericType", enumGT);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(prop, "multiplicity", pureOne);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(prop, "owner", enumeration);
            org.finos.legend.pure.truffle.runtime.helper._Any.write(prop, "aggregation",
                    org.finos.legend.pure.truffle.runtime.module.EnumValueSingletons.valueOf(
                            "meta::pure::metamodel::function::property::AggregationKind", "None"));
            org.finos.legend.pure.truffle.runtime.helper._Any.write(prop, "defaultValue", lambda);

            properties[i] = prop;
        }

        org.finos.legend.pure.truffle.runtime.helper._Any.write(enumeration, "properties", new ObjectSequence(properties));
        return enumeration;
    }
}
