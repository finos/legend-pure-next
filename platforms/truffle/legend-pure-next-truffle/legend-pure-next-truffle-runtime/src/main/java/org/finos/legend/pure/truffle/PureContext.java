...
import org.finos.legend.pure.truffle.interpreter.PureASTBuilder;
import org.finos.legend.pure.truffle.interpreter.ast.root.CompiledFunction;
import org.finos.legend.pure.truffle.interpreter.FrameDescriptorBuilder;
...
import org.finos.legend.pure.truffle.interpreter.ast.root.PureFunctionRootNode;
import org.finos.legend.pure.truffle.interpreter.ast.root.RawLambdaRootNode;
...
public final class PureContext
{
    ...
    private static final int SLOT_CLASSIFIER_GENERIC_TYPE = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("classifierGenericType");
    ...
    private static final int SLOT_SOURCE_ID = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("sourceId");
    private static final int SLOT_SOURCE_INFORMATION = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("sourceInformation");
    private static final int SLOT_START_COLUMN = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("startColumn");
    private static final int SLOT_START_LINE = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("startLine");
    private static final int SLOT_TYPE_VARIABLE_VALUES = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("typeVariableValues");
    private static final int SLOT_TYPE_VARIABLES = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("typeVariables");
    ...
    private TruffleModuleRegistry modules;
    ...
    private final java.util.Map<org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject, Object> enumCgtCache =
    ...
    public void unregisterModule(String name)
    {
        ...
        toClear.add(name);
        for (TruffleModule m : modules.modules())
        {
                    ...
                    java.util.Map<String, org.finos.legend.pure.next.parser.GrammarExtension> grammars)
    {
        ...
        this.modules = (resolver instanceof TruffleModuleRegistry r) ? r : null;
     ...
     * TruffleModuleRegistry}. Returns
     * null for legacy anonymous resolvers — callers that need module info
     * must check.
     */
    public TruffleModuleRegistry modules() { return modules; }
    ...
    public RootCallTarget callTargetForLambda(Object lambda)
    {
        ...
        try
        {
            ...
            try
            {
                Object exprSeqObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambda, SLOT_EXPRESSION_SEQUENCE);
                ...
                else
                {
                    ...
                    for (int i = 0; i < openVars.size(); i++)
                    {
                        ...
                        Object nameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(ov, SLOT_NAME);
    ...
    public Object classifierGenericType(Object value)
    {
        ...
        if (value instanceof org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdo)
        {
            ...
            {
                String enumPath = org.finos.legend.pure.truffle.runtime.module.EnumValueSingletons.enumerationPathOf(pdo);
    ...
    private static final org.finos.legend.pure.truffle.runtime.module.PureClassInfo ENUM_CLASS_INFO =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.enumClassInfo();

    @com.oracle.truffle.api.CompilerDirectives.TruffleBoundary
    private Object resolveStaticEnumCgt(org.finos.legend.pure.truffle.runtime.pdo.PureDynamicObject pdo, String enumPath)
    {
    ...
    private static final int SLOT_CGT =
            org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("classifierGenericType");
    ...
    public Object resolveQpDispatch(Object staticQp, Object[] rawArgs)
    {
        ...
        String qpName = (String) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(staticQp, SLOT_NAME);
        ...
        for (Object type : mro)
        {
            Object qpsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_QUALIFIED_PROPERTIES);
            ...
            for (Object candidate : qps.toBoxedArray())
            {
                ...
                if (cqpParamsObj instanceof org.finos.legend.pure.truffle.types.PureSequence cqpParams
                        ...
                        && org.finos.legend.pure.truffle.runtime.helper._Any.isType(candidate,
    ...
    public static void bindQpTypeVariablesStatic(Object target, VirtualFrame frame, FrameLayout layout)
    {
        Object cgt = getClassifierGenericType(target);
        if (cgt == null) return;
        Object tvvObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(cgt, SLOT_TYPE_VARIABLE_VALUES);
        ...
        Object typeVarsObj = ownerType != null
                ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(ownerType, SLOT_TYPE_VARIABLES) : null;
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            Object tvNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(tvObj, SLOT_NAME);
            ...
            if (slot != null)
            {
                ...
                if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(tvVal,
                        "meta::pure::metamodel::valuespecification::AtomicValue"))
                {
                    tvVal = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(tvVal, SLOT_VALUE);
                }
                if (tvVal != null)
                {
    ...
    private static Object getClassifierGenericType(Object target)
    {
        ...
        return org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(target, SLOT_CLASSIFIER_GENERIC_TYPE);
    }
    ...
    public org.finos.legend.pure.truffle.interpreter.ast.root.CompiledFunction compileLambdaFunction(Object lambda)
    {
    ...
    private CompiledFunction compile(Object fd)
    {
        ...
        try
        {
            Object exprSeqObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fd, SLOT_EXPRESSION_SEQUENCE);
            ...
            boolean isLambda = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(fd,
            ...
            if (!isLambda)
            {
                ...
                try
                {
                    Object si = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fd, SLOT_SOURCE_INFORMATION);
                    if (si == null && exprSeqObj instanceof org.finos.legend.pure.truffle.types.PureSequence exprSeq && !exprSeq.isEmpty())
                    {
                        ...
                        si = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(firstExpr, SLOT_SOURCE_INFORMATION);
                    }
                    rootSource = org.finos.legend.pure.truffle.interpreter.PureSourceHelper.createSourceSection(si);
                }
                catch (Exception e) { throw new RuntimeException("Failed to set source information", e); }
                boolean mayBindTypeVars = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(fd,
    ...
    private FunctionTypeVarPlan computeFunctionTypeVarPlan(Object fd)
    {
        try
        {
            Object cgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fd, SLOT_CLASSIFIER_GENERIC_TYPE);
            ...
            Object functionType = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(functionTypeGT,
                    org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("type"));
            if (functionType == null) return FunctionTypeVarPlan.EMPTY;
            Object paramsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(functionType, SLOT_PARAMETERS);
            ...
            int multiplicitySlot = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("multiplicity");
            for (int i = 0; i < params.size(); i++)
            {
                ...
                // would miss them.
                Object paramGT = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(param,
                        org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("genericType"));
                if (paramGT != null)
                {
                    Object paramType = org.finos.legend.pure.truffle.runtime.helper._GenericType.type(paramGT);
                    if (paramType != null
                            && org.finos.legend.pure.truffle.runtime.helper._Any.isType(paramType,
                                    "meta::pure::metamodel::type::generics::TypeParameter", resolver))
                    {
                        Object nameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(paramType, SLOT_NAME);
                        if (nameObj instanceof String s)
                        {
                            tIdx.add(i);
                            tNames.add(s);
                ...
                Object paramMul = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(param, multiplicitySlot);
                if (paramMul != null
                        && org.finos.legend.pure.truffle.runtime.helper._Any.isType(paramMul,
                                "meta::pure::metamodel::multiplicity::MultiplicityParameter", resolver))
                {
                    Object nameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(paramMul, SLOT_NAME);
                    if (nameObj instanceof String s)
                    {
                        mIdx.add(i);
                        mNames.add(s);
    ...
    ParamShapePlan computeParamShapePlan(Object fd)
    {
        try
        {
            Object paramsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fd, SLOT_PARAMETERS);
            if (!(paramsObj instanceof org.finos.legend.pure.truffle.types.PureSequence params) || params.isEmpty())
            {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                if (p == null) continue;
                Object mul = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(p, SLOT_MULTIPLICITY);
                if (mul == null) continue;
                // MultiplicityParameter (e.g. `m`) — bounds are parametric, skip.
                if (org.finos.legend.pure.truffle.runtime.helper._Any.isType(mul,
                        "meta::pure::metamodel::multiplicity::MultiplicityParameter", resolver))
                {
                    continue;
                }
                Object lbObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mul, SLOT_LOWER_BOUND);
                Object ubObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(mul, SLOT_UPPER_BOUND);
    ...
    private static Long readMultiplicityBoundValue(Object boundObj)
    {
        ...
        Object v = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(boundObj,
                org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("value"));
    ...
    private String getFunctionName(Object fd)
    {
        ...
        try
        {
            Object fnNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(
                    fd, org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("functionName"));
            if (fnNameObj instanceof String fnName && !fnName.isEmpty())
            {
                Object pkg = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(
                        fd, org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("package"));
                if (pkg != null)
                {
    ...
    private static String lambdaProfileName(Object lambda)
    {
        try
        {
            Object si = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambda, SLOT_SOURCE_INFORMATION);
            if (si != null)
            {
                Object sourceIdObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(si, SLOT_SOURCE_ID);
                if (sourceIdObj instanceof String sourceId)
                {
                    return "lambda@" + sourceId
                            + ":" + org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(si, SLOT_START_LINE)
                            + ":" + org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(si, SLOT_START_COLUMN);
                }
            }
        }
        catch (RuntimeException ignored) {}
