...
package org.finos.legend.pure.truffle.interpreter.ast.variable;
...
public final class RawLambdaCaptureNode extends PureNode
{
                                ...
                                FrameLayout layout)
    {
        ...
        for (int i = 0; i < openVars.size(); i++)
        {
            ...
            String name;
            if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(varObj,
                    "meta::pure::metamodel::valuespecification::VariableExpression"))
            {
                name = (String) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(varObj, SLOT_NAME);
            }
            else
            {
