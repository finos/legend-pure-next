 ...
 * needs the metaclass identity which {@code _Any.pureTypeIs} reports
...
public final class RawUserFunctionCallNode extends PureNode
{
    ...
    public Object executeGeneric(VirtualFrame frame)
    {
        ...
        if (args.length > 0 && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(fd, QUALIFIED_PROPERTY_PATH))
        {
