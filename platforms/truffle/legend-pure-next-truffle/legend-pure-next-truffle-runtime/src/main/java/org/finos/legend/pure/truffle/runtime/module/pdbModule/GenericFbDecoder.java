...
import org.finos.legend.pure.truffle.runtime.module.EnumValueSingletons;
...
public final class GenericFbDecoder
{
     ...
     */
    @TruffleBoundary
    public static Object decode(String name, Object fb, TruffleMetadataAccess resolver, Object parent)
    {
        if (fb == null)
        {
            return null;
     ...
     * "Def"). Public: {@code TrufflePdbLoader} uses it to type root elements —
     * the replacement for its hardcoded TYPE_TO_WRAPPER map.
     */
    @TruffleBoundary
    public static String purePathForDef(String defName, TruffleMetadataAccess resolver)
    {
    ...
    private static final class FieldPlan
    {
        ...
        Object read(Object fb, TruffleMetadataAccess resolver, Object parent)
        {
            try
            {
                return switch (shape)
        ...
        private Object decodeVector(Object fb, TruffleMetadataAccess resolver, Object parent) throws Exception
        {
            int len = (Integer) length.invoke(fb);
            if (len == 0)
            {
        ...
        private Object decodeUnionMember(byte uType, Object fb, Integer idx,
                TruffleMetadataAccess resolver, Object parent) throws Exception
        {
        ...
        private Object decodeStringScalar(String raw, Object fb, TruffleMetadataAccess resolver)
        {
            if (raw == null)
            {
                return null;
        ...
        private Object decodeStringVectorItem(String raw, TruffleMetadataAccess resolver)
        {
            if (raw == null)
            {
                return null;
                ...
                TruffleMetadataAccess resolver)
        {
            ...
            if (!(prof instanceof org.finos.legend.pure.truffle.runtime.PropertyAccessor pa))
            {
                return null;
            }
            ...
            if (pa.readProperty(listProperty) instanceof PureSequence seq)
            {
                for (int i = 0; i < seq.size(); i++)
                {
                    ...
                    if (ann instanceof org.finos.legend.pure.truffle.runtime.PropertyAccessor annPa
        ...
        private StringTypeInfo stringTypeInfo(TruffleMetadataAccess resolver)
        {
    ...
    private static Object nestedPdo(String defName, Object def, TruffleMetadataAccess resolver, Object parent)
    {
    ...
    private static StringTypeInfo resolveStringTypeInfo(String tableName, String pureProperty,
            String rawFieldName, TruffleMetadataAccess resolver)
    {
