...
public final class StartsWithNode extends PureNode
{
    private static final String SIG = "startsWith_String_1__String_1__Boolean_1_";
    ...
    public StartsWithNode(PureNode strArg, PureNode prefixArg)
    {
        this.strArg = strArg;
