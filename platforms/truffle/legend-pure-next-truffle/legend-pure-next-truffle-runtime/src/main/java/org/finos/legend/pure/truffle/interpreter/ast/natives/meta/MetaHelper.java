...
public final class MetaHelper
{
    ...
    public static Object getRawValueType(Object value, TruffleMetadataAccess resolver)
    {
        ...
        if (value instanceof org.finos.legend.pure.truffle.types.RawClosure rc)
        {
            return getRawValueType(rc.lambda(), resolver);
        }
        if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(value) != null)
        {
    ...
    public static Object getRawGenericType(Object value)
    {
        ...
        if (value != null
                && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(value) != null)
        {
