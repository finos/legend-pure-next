...
package org.finos.legend.pure.truffle.interpreter.ast.property;
...
public final class RawPropertyAccessNode extends PureNode
{
    ...
    public RawPropertyAccessNode(Object fe, PureNode[] argNodes)
    {
        ...
        Object func = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_FUNC);
        this.isQualifiedProperty = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(func,
                "meta::pure::metamodel::function::property::QualifiedProperty");
        if (!isQualifiedProperty)
        {
            Object nameObj = func != null
                    ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(func, SLOT_NAME)
                    : null;
            String name = nameObj instanceof String s ? s : null;
            if (name == null)
            {
                Object fnName = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fe, SLOT_FUNCTION_NAME);
    ...
    public Object executeGeneric(VirtualFrame frame)
    {
        ...
        if (propName != null && argValues.length > 0)
        {
            ...
            if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(target,
                    "meta::pure::metamodel::type::Enumeration"))
            {
                ...
                if (viaProp != org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode.ABSENT)
                {
                    return viaProp;
                }
                ...
                if (fromProps != org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode.ABSENT)
                {
                    return fromProps;
                }
    ...
    {
        Object valuesObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(target, SLOT_VALUES);
        if (valuesObj instanceof org.finos.legend.pure.truffle.types.PureSequence values)
        {
            for (int i = 0; i < values.size(); i++)
            {
                ...
                if (enumValue != null && propName.equals(
                        org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(enumValue, SLOT_NAME)))
                {
                    return enumValue;
                }
            }
     ...
     * org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode#ABSENT} when no
    ...
    {
        Object propsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(target, SLOT_PROPERTIES);
        if (propsObj instanceof org.finos.legend.pure.truffle.types.PureSequence properties)
        {
            for (int i = 0; i < properties.size(); i++)
            {
                ...
                if (prop != null && propName.equals(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(prop, SLOT_NAME)))
                {
                    ...
                    if (dv == null) continue;
                    Object dvSeqObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(dv, SLOT_EXPRESSION_SEQUENCE);
                    if (!(dvSeqObj instanceof org.finos.legend.pure.truffle.types.PureSequence dvSeq) || dvSeq.isEmpty())
                    {
                        continue;
                    }
                    Object expr = dvSeq.getBoxed(0);
                    if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(expr,
                            "meta::pure::metamodel::valuespecification::AtomicValue"))
                    {
                        return org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(expr, SLOT_VALUE);
                    }
                }
            }
        }
        return org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode.ABSENT;
    }
    ...
    {
        String enPath = org.finos.legend.pure.truffle.runtime.helper._PackageableElement.path(target, resolver);
