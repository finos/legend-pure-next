...
public final class CastNode extends PureNode
{
    ...
    private static final int SLOT_CONSTRAINTS = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("constraints");
    private static final int SLOT_FUNCTION_DEFINITION = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("functionDefinition");
    ...
    private static final int SLOT_MESSAGE_FUNCTION = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("messageFunction");
    ...
    private static Object doCast(Object inputResult, Object targetResult, TruffleMetadataAccess resolver, RawLambdaCallNode constraintCallNode)
    {
        ...
        Object hoistedGT = targetResult != null
                ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(targetResult, SLOT_GENERIC_TYPE) : null;
        if (hoistedGT != null)
        {
            ...
            Object mulArgsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(hoistedGT,
                    org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("multiplicityArguments"));
        ...
        boolean targetTypeUndefined = targetGT != null
                && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(targetGT,
                        "meta::pure::metamodel::type::generics::UndefinedGenericType");
        boolean targetMulUndefined = targetMul != null
                && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(targetMul,
        ...
        if (!targetTypeUndefined
                && targetType != null
                && org.finos.legend.pure.truffle.runtime.helper._Any.isType(targetType,
                        "meta::pure::metamodel::type::generics::TypeParameter", resolver))
        {
            Object tvNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(targetType, SLOT_NAME);
        ...
        if (!targetMulUndefined
                && targetMul != null
                && org.finos.legend.pure.truffle.runtime.helper._Any.isType(targetMul,
                        "meta::pure::metamodel::multiplicity::MultiplicityParameter", resolver))
        {
            Object mvNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(targetMul, SLOT_NAME);
        ...
        if (!targetTypeUndefined
                ...
                && !org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(inputResult,
                    ...
                    && !targetPath.startsWith("meta::pure::metamodel::valuespecification::"))
            {
                ...
                if (sourceType != null)
                {
                    ...
                    if (sourcePath != null && !"meta::pure::metamodel::type::Nil".equals(sourcePath))
                    {
                        ...
                        if (!related)
                        {
                            Object srcName = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(sourceType, SLOT_NAME);
                            Object tgtName = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(targetType, SLOT_NAME);
            ...
            java.util.Set<Object> visited)
    {
        ...
        Object constraintsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_CONSTRAINTS);
                                                   ...
                                                   RawLambdaCallNode constraintCallNode)
    {
        ...
        Object typeNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_NAME);
        ...
        Object typeVarValsObj = targetGT != null
                ? org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(targetGT, SLOT_TYPE_VARIABLE_VALUES) : null;
        if (typeVarValsObj instanceof org.finos.legend.pure.truffle.types.PureSequence typeVarVals
                && typeVarVals.size() > 0)
        {
            Object typeVarsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(type, SLOT_TYPE_VARIABLES);
            if (typeVarsObj instanceof org.finos.legend.pure.truffle.types.PureSequence typeVars)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(rawVal,
                            "meta::pure::metamodel::valuespecification::AtomicValue"))
                    {
                        Object inner = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(rawVal, SLOT_VALUE);
                        if (inner != null) rawVal = inner;
                    }
                    Object rawTypeVar = typeVars.getBoxed(i);
                    Object tvNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(rawTypeVar, SLOT_NAME);
        ...
        for (int idx = 0; idx < constraints.size(); idx++)
        {
            ...
            Object funcDef = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(c, SLOT_FUNCTION_DEFINITION);
            if (funcDef == null)
            {
                continue;
            }
            ...
            Object funcParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(funcDef, SLOT_PARAMETERS);
            if (funcParamsObj instanceof org.finos.legend.pure.truffle.types.PureSequence funcParams && funcParams.size() > 1)
            {
                for (int p = 1; p < funcParams.size(); p++)
                {
                    ...
                    Object tvNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(rawParam, SLOT_NAME);
                    if (tvNameObj instanceof String tvName)
                    {
            ...
            {
                Object cNameObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(c, SLOT_NAME);
                ...
                Object messageFn = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(c, SLOT_MESSAGE_FUNCTION);
                if (messageFn != null)
                {
                    try
                    {
                        ...
                        msgArgs.add(value);
                        Object msgParamsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(messageFn, SLOT_PARAMETERS);
    ...
    {
        Object lowerBound = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(concreteMul,
                org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("lowerBound"));
        Object upperBound = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(concreteMul,
                org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("upperBound"));
