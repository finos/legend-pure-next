...
public final class NewMapNode extends PureNode
{
    ...
    private static Object buildMap(Object pairs, Object mapCGT)
    {
        ...
        org.finos.legend.pure.truffle.runtime.helper._Any.write(map, "classifierGenericType", mapCGT);
        ...
        for (int i = 0; i < sz; i++)
        {
            ...
            {
                map.put(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(pair, SLOT_FIRST),
