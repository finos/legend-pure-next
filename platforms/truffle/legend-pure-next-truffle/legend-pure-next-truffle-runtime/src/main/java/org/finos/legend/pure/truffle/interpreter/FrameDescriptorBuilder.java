 ...
 * {@link org.finos.legend.pure.truffle.interpreter.ast.variable.RawLambdaCaptureNode} reads its
...
public final class FrameDescriptorBuilder
{
    ...
    public static FrameLayout analyze(Object fd)
    {
        ...
        if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(fd,
        ...
        org.finos.legend.pure.truffle.types.PureSequence params = (org.finos.legend.pure.truffle.types.PureSequence) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fd, SLOT_PARAMETERS);
        ...
        if (params != null)
        {
            ...
            {
                String name = (String) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(params.getBoxed(i), SLOT_NAME);
                int slot = allocateSlot(builder, slots, name);
                paramSlots[i] = slot;
            }
        }

        Object bodyExprs = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(fd, SLOT_EXPRESSION_SEQUENCE);
    ...
    public static FrameLayout analyzeMinimal(Object fd)
    {
        ...
        if (params != null)
        {
            for (int i = 0; i < params.size(); i++)
            {
                paramSlots[i] = allocateSlot(builder, slots, (String) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(params.getBoxed(i), SLOT_NAME));
            }
        }
        return new FrameLayout(builder.build(), slots, paramSlots);
    }
     ...
     * resolve via {@link org.finos.legend.pure.truffle.interpreter.ast.variable.FrameVariableReadNode}
    ...
    private static FrameLayout analyzeLambda(Object lambda)
    {
        ...
        org.finos.legend.pure.truffle.types.PureSequence params = (org.finos.legend.pure.truffle.types.PureSequence) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambda, SLOT_PARAMETERS);
        int[] paramSlots = new int[params == null ? 0 : params.size()];
        if (params != null)
        {
            for (int i = 0; i < params.size(); i++)
        ...
        org.finos.legend.pure.truffle.types.PureSequence openVars = (org.finos.legend.pure.truffle.types.PureSequence) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambda, SLOT_OPEN_VARIABLES);
        if (openVars != null)
        {
            for (int i = 0; i < openVars.size(); i++)
            {
                allocateSlot(builder, slots, (String) org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(openVars.getBoxed(i), SLOT_NAME));
            }
        }

        collectLetTargets(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambda, SLOT_EXPRESSION_SEQUENCE), builder, slots);
        // Safety net: scan for variable reads to catch let targets missed
        collectVariableReads(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(lambda, SLOT_EXPRESSION_SEQUENCE), builder, slots);
    ...
    // org.finos.legend.pure.truffle.interpreter.PureASTBuilder#lowerNativeCall}
                                          ...
                                          Map<String, Integer> slots)
    {
        ...
        try
        {
            ...
            if (func != null
                    && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(func,
                            "meta::pure::metamodel::function::NativeFunction"))
            {
                Object nfName = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(func, SLOT_NAME);
        ...
        if (!isLet && "letFunction".equals(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_FUNCTION_NAME)))
        {
            isLet = true;
        }
        if (isLet)
    ...
    private static boolean containsLambdaIn(Object vs)
    {
        ...
        {
            Object inner = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_VALUE);
        ...
        {
            Object valsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_VALUES);
    ...
    private static String extractLetName(Object fe)
    {
        ...
        if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(first,
                "meta::pure::metamodel::valuespecification::AtomicValue"))
        {
            Object inner = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(first, SLOT_VALUE);
    ...
    private static void scanForVariableReads(Object vs,
                                             ...
                                             Map<String, Integer> slots)
    {
        String pureType = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(vs);
        if ("meta::pure::metamodel::valuespecification::VariableExpression".equals(pureType))
        {
            Object n = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_NAME);
                    ...
                    || pureType.endsWith("ArrowInvocation")))
        {
            try
            {
                Object argsObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(vs, SLOT_PARAMETERS_VALUES);
