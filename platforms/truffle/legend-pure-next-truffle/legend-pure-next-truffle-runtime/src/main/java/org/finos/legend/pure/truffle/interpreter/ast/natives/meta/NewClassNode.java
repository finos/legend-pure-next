...
public final class NewClassNode extends PureNode
{
    ...
    private static Object doNewClass(Object typeParams, Object multParams, TruffleMetadataAccess resolver)
    {
        ...
        org.finos.legend.pure.truffle.runtime.helper._Any.write(cls, "typeParameters", tpSeq);
        org.finos.legend.pure.truffle.runtime.helper._Any.write(cls, "multiplicityParameters", mpSeq);
        ...
        if (!tpSeq.isEmpty())
        {
            ...
            for (int i = 0; i < tpSeq.size(); i++)
            {
                ...
                if (org.finos.legend.pure.truffle.runtime.helper._Any.isType(tp,
                        "meta::pure::metamodel::type::generics::TypeParameter", resolver))
                {
                    org.finos.legend.pure.truffle.runtime.helper._Any.write(tp, "owner", cls);
            ...
            org.finos.legend.pure.truffle.runtime.helper._Any.write(selfGT, "typeArguments", new ObjectSequence(tpGTs));
        }
        ...
        if (!mpSeq.isEmpty())
        {
            ...
            for (int i = 0; i < mpSeq.size(); i++)
            {
                ...
                if (org.finos.legend.pure.truffle.runtime.helper._Any.isType(mp,
                        "meta::pure::metamodel::multiplicity::MultiplicityParameter", resolver))
                {
                    org.finos.legend.pure.truffle.runtime.helper._Any.write(mp, "owner", cls);
                }
                mpArgs[i] = mp;
            }
            org.finos.legend.pure.truffle.runtime.helper._Any.write(selfGT, "multiplicityArguments", new ObjectSequence(mpArgs));
        }
        ...
        org.finos.legend.pure.truffle.runtime.helper._Any.write(cgt, "typeArguments", new ObjectSequence(new Object[]{selfGT}));

        org.finos.legend.pure.truffle.runtime.helper._Any.write(cls, "classifierGenericType", cgt);
