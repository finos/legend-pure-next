...
public final class ElementToPathNode extends PureNode
{
            ...
            TruffleMetadataAccess resolver)
    {
        ...
        // path() handles both pointers (short-circuits to the .path slot) and
        // regular PackageableElements (walks the package chain). Single entry
        // point keeps this native a thin separator-application wrapper.
        if (element != null && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(element) != null)
        {
