...
package org.finos.legend.pure.truffle.interpreter.ast.natives.string;
...
public final class ToStringNode extends PureNode
{
    ...
    private static final int SLOT_FIRST = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("first");
    private static final int SLOT_NAME = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("name");
    private static final int SLOT_SECOND = org.finos.legend.pure.truffle.runtime.module.PureClassRegistry.globalSlot("second");
    ...
    @Child
    private org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode toStringReader = new org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode();
    ...
    private static String convert(Object v, org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode reader)
    {
        if (v == null)
        {
            return "";
    ...
    static String enumQualifiedPath(Object v)
    {
        ...
        String pureType = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(v);
        ...
        {
            Object name = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(v, SLOT_NAME);
            if (name instanceof String s)
            {
                Object cgt = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(v, SLOT_CLASSIFIER_GENERIC_TYPE);
                if (cgt != null)
                {
    ...
    @TruffleBoundary
    static String pureToString(Object v, org.finos.legend.pure.truffle.interpreter.ast.property.PropertyReadNode reader)
    {
        if (v == null)
        {
            return "";
        ...
        {
            Object valuesObj = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(v, SLOT_VALUES);
        ...
        {
            return "<" + pureToString(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(v, SLOT_FIRST), reader)
                    + ", " + pureToString(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(v, SLOT_SECOND), reader) + ">";
        }
        ...
        if (v instanceof String s && s.contains("::") && s.contains("."))
        {
            ...
            if (dotIdx > 0 && dotIdx < s.length() - 1)
            {
                ...
                if (prefix.contains("::"))
                {
                    Object enumType = org.finos.legend.pure.truffle.PureLanguage.get(null).resolver().getElement(prefix);
                    if (enumType != null
                            && org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(enumType,
