...
public final class CompiledFunction
{
    ...
    private volatile org.finos.legend.pure.truffle.interpreter.ast.PureNode[] body;
    ...
    public org.finos.legend.pure.truffle.interpreter.ast.PureNode[] body()
    {
        return body;
    }

    public void setBody(org.finos.legend.pure.truffle.interpreter.ast.PureNode[] body)
    {
        this.body = body;
    }
