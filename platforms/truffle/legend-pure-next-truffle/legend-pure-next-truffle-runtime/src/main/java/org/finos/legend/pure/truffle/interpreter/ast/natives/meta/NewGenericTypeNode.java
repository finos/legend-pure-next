...
public final class NewGenericTypeNode extends PureNode
{
    ...
    {
        if (result == null
                || !org.finos.legend.pure.truffle.runtime.helper._Any.isType(result,
                        "meta::pure::metamodel::type::generics::GenericTypeValue", resolver))
        {
            String pt = org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeOf(result);
        ...
        if (rawType != null)
        {
            ...
            {
                Object n = org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(rawType, SLOT_NAME);
     ...
     * registered in {@link org.finos.legend.pure.truffle.runtime.module.PureClassRegistry}.
    ...
    private static String resolveShapeFromGeneralizations(Object rawType,
            TruffleMetadataAccess resolver)
    {
        Object gens = org.finos.legend.pure.truffle.runtime.helper._Any.read(rawType, "generalizations");
        if (gens instanceof org.finos.legend.pure.truffle.types.PureSequence seq)
        {
            for (int i = 0; i < seq.size(); i++)
            {
                ...
                Object general = org.finos.legend.pure.truffle.runtime.helper._Any.read(gen, "general");
