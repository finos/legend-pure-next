...
public final class PutAllNode extends PureNode
{
    ...
    private static Object doPutAll(Object map, Object other, Object mapCGT)
    {
        ...
        org.finos.legend.pure.truffle.runtime.helper._Any.write(newMap, "classifierGenericType", mapCGT);
        ...
        else
        {
            ...
            for (int i = 0; i < sz; i++)
            {
                ...
                if (org.finos.legend.pure.truffle.runtime.helper._Any.pureTypeIs(pair,
                        "meta::pure::functions::collection::Pair"))
                {
                    newMap.put(org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(pair, SLOT_FIRST),
                            org.finos.legend.pure.truffle.runtime.helper._Any.readBySlot(pair, SLOT_SECOND));
                }
            }
        }
        return newMap;
