...
public final class CompiledFunction
{
    ...
    private volatile org.finos.legend.pure.truffle.execution.ast.PureNode[] body;
    ...
    public org.finos.legend.pure.truffle.execution.ast.PureNode[] body()
    {
        return body;
    }

    public void setBody(org.finos.legend.pure.truffle.execution.ast.PureNode[] body)
    {
        this.body = body;
    }
