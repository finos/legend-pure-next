 ...
 * does the reconstruction inline; the Truffle decode path
 * ({@code GenericFbDecoder}) delegates here so the AST stays small.</p>
 *
 ...
 * {@link EnumValueSingletons}, which {@code PureContext#classifierGenericType}
...
public final class AtomicValueEnumReconstructor
{
     ...
     */
    public static Object reconstruct(String raw, Object genericType, MetadataAccess resolver)
    {
    ...
    private static Object readSlot(Object holder, String name)
    {
        ...
        if (holder instanceof org.finos.legend.pure.truffle.execution.PropertyAccessor pa) return pa.readProperty(name);
        return null;
    }
                                         ...
                                         MetadataAccess resolver)
    {
        ...
        // Register with EnumValueSingletons so PureContext can lazily compute
        ...
        {
            EnumValueSingletons.register(pdo, enumerationPath);
        }
        return pdo;
    }
}
