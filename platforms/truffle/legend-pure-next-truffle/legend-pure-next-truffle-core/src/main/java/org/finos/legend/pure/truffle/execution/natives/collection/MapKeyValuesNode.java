...
public final class MapKeyValuesNode extends PureNode
{
    ...
    private static Object doKeyValues(Object map, MetadataAccess resolver)
    {
        if (map instanceof MapImpl mi)
        {
            ...
            for (java.util.Map.Entry<Object, Object> entry : raw.entrySet())
            {
                ...
                org.finos.legend.pure.truffle.compiler.helper._Any.write(pair, "first", entry.getKey());
                org.finos.legend.pure.truffle.compiler.helper._Any.write(pair, "second", entry.getValue());
                pairs[i++] = pair;
            }
