 ...
 * ({@link org.finos.legend.pure.truffle.execution.natives.meta.NewWithKeysNode},
 * {@link org.finos.legend.pure.truffle.execution.natives.meta.CopyWithKeysNode},
 * {@link PropertyAssignNode}) and the reverse-association walker.
 *
 * <p>The receiver is always a {@link PropertyAccessor} — either a
 * {@link org.finos.legend.pure.truffle.execution.PureDynamicObject} (the
 * universal Pure-object kind) or a hand-written collection implementation
 * (e.g. {@link org.finos.legend.pure.truffle.execution.types.MapImpl}).
