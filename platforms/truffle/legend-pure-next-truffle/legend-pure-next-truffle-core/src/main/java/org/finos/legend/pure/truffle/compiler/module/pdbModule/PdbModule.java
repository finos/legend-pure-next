 ...
 *
 * <p>Implements {@link MetadataAccess} so it can be passed directly to
...
public final class PdbModule implements Module
{
    ...
    private final TypeCache typeCache =
            new TypeCache();
    private MetadataAccess resolver = this; // default: self. Set to composite for multi-module.

    /**
     * Open a PDB and adopt the identity declared in its embedded manifest.
     */
    /** Open a .pdb archive as a module; its identity comes from the archive's manifest. */
    public static PdbModule open(Path pdbPath) throws IOException
    {
        return new PdbModule(pdbPath);
    }

    public PdbModule(Path pdbPath) throws IOException
    {
     ...
     */
    public void setResolver(MetadataAccess compositeResolver)
    {
    ...
    /**
     * Stage 1 bridge for the {@link org.finos.legend.pure.truffle.execution.PureDynamicObject}
     ...
     */
    public org.finos.legend.pure.truffle.execution.PureDynamicObject getElementAsDynamic(String path)
    {
        ...
        return elem instanceof org.finos.legend.pure.truffle.execution.PureDynamicObject pdo ? pdo : null;
    }
     ...
     * {@link org.finos.legend.pure.truffle.execution.PureDynamicObject}.
