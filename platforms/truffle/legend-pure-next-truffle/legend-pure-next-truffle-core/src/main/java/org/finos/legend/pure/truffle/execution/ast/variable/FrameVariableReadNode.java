 ...
 * org.finos.legend.pure.truffle.execution.FrameDescriptorBuilder}). The slot
...
public final class FrameVariableReadNode extends PureNode
{
    ...
    public Object executeGeneric(VirtualFrame frame)
    {
        if (slot < 0)
        {
            ...
            throw new org.finos.legend.pure.truffle.execution.ast.PureException("Unknown variable: " + name, this);
        }
