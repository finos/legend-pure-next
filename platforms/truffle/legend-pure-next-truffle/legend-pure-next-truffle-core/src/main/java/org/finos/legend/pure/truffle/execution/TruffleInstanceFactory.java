...
/**
 * Creates {@link org.finos.legend.pure.truffle.execution.PureDynamicObject}
...
public final class TruffleInstanceFactory
{
    ...
    public static Object createInstance(String classPath, MetadataAccess resolver)
    {
        return new org.finos.legend.pure.truffle.execution.PureDynamicObject(
                org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.classInfoFor(classPath, resolver),
                /*fb=*/ null,
                resolver,
                /*parent=*/ null);
    }
    ...
    {
        return new org.finos.legend.pure.truffle.execution.PureDynamicObject(
                org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.classInfoFor(classPath, null),
                /*fb=*/ null,
                /*resolver=*/ null,
                /*parent=*/ null);
    }
