...
public final class _PackageableElement
{
    ...
    @TruffleBoundary
    public static String path(Object pe, MetadataAccess resolver)
    {
        if (pe == null)
        {
            return null;
    ...
    private static final int SLOT_POINTER_PATH =
            org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("path");
    ...
    {
        return obj instanceof org.finos.legend.pure.truffle.execution.PureDynamicObject pdo
                ? pdo.readSlot(SLOT_PACKAGE)
                : org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(obj, SLOT_PACKAGE);
    }
    ...
    private static Object readName(Object obj)
    {
        return obj instanceof org.finos.legend.pure.truffle.execution.PureDynamicObject pdo
                ...
                : org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(obj, SLOT_NAME);
    }
    ...
    private static String packagePath(Object pkg)
    {
        ...
        int depth = 0;
        while (current != null
                && org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(current, PACKAGE_PURE_PATH)
                && depth < 15)
        {
