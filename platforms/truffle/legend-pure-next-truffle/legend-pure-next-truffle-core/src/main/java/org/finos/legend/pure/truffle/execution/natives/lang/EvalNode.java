...
public final class EvalNode extends PureNode
{
     ...
     */
    public static Object dispatch(org.finos.legend.pure.truffle.execution.PureContext evaluator, Object fn, Object[] args,
                                    org.finos.legend.pure.truffle.execution.ast.property.PropertyReadNode propertyReader)
    {
        ...
        if (org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(fn,
                ...
                "meta::pure::metamodel::function::property::Property"))
        {
            if (args.length > 0)
            {
                return propertyReader.execute(args[0],
                        (String) org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(fn, SLOT_NAME));
            }
            return org.finos.legend.pure.truffle.execution.types.PureSequence.EMPTY;
        }
        MetadataAccess resolver = evaluator.resolver();
        if (org.finos.legend.pure.truffle.compiler.helper._Any.isType(fn,
    ...
    @com.oracle.truffle.api.CompilerDirectives.TruffleBoundary
    private static Object executeNativeViaRegistry(org.finos.legend.pure.truffle.execution.PureContext evaluator, Object nf, Object[] args)
    {
        String signature = (String) org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(nf, SLOT_NAME);
        NativeRegistry registry = evaluator.astBuilder().specialized();
        NativeRegistry.Factory factory = registry.lookup(signature);
        if (factory == null)
        {
