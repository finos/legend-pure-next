...
import org.finos.legend.pure.truffle.execution.ast.PureException;
...
public final class AssertErrorNode extends PureNode
{
    ...
    private boolean doAssertError(Object rawFn, String expectedMessage)
    {
        ...
        try
        {
            ...
            else if (org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(fn,
        ...
        catch (Exception e)
        {
            ...
            // exception message via bootstrap NativeRegistry's wrap; Truffle stores it
            ...
            {
                String pureStack = org.finos.legend.pure.truffle.execution.PureStackFormatter.format(e);
