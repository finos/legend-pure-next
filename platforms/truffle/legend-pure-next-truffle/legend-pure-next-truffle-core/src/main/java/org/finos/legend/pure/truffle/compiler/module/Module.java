 ...
 * references.
 *
 * <p>Modules are the unit of lifecycle: a {@link ModuleRegistry} can
 ...
 */
public interface Module extends MetadataAccess
{
    ...
    /** The package pattern from the module manifest; null for modules not bound to one. */
    default String packagePattern()
    {
        return null;
    }
}
