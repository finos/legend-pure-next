...
public final class CopySimpleNode extends PureNode
{
    ...
    private static final int SLOT_TYPE_ARGUMENTS = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("typeArguments");
    @Child
    ...
    public Object executeGeneric(VirtualFrame frame)
    {
        ...
        var eval = org.finos.legend.pure.truffle.execution.PureLanguage.get(this);
        eval.pushFreshScope();
    ...
    private static Object doCopy(Object original, MetadataAccess resolver)
    {
        if (original == null)
        {
        ...
        if (cgt != null)
        {
            org.finos.legend.pure.truffle.compiler.helper._Any.write(copy, "classifierGenericType",
    ...
    {
        org.finos.legend.pure.truffle.execution.PureDynamicObject src =
                (org.finos.legend.pure.truffle.execution.PureDynamicObject) original;
        ...
        {
            if (src.slots[i] == org.finos.legend.pure.truffle.execution.PureDynamicObject.LAZY)
            {
                src.readSlot(i);
            }
        }
    ...
    {
        if (org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(gtv, SLOT_TYPE) == original) return true;
        Object taObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(gtv, SLOT_TYPE_ARGUMENTS);
        if (taObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence typeArgs)
        {
                                                ...
                                                MetadataAccess resolver)
    {
        ...
        var result = org.finos.legend.pure.truffle.compiler.helper._GenericType.buildUserDefinedGenericType(
                null, resolver);
        ...
        Object type = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(gtv, SLOT_TYPE);
        if (type == original && copy != null)
        {
            org.finos.legend.pure.truffle.compiler.helper._Any.write(result, "type", copy);
        }
        else if (org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(type,
                "meta::pure::metamodel::type::generics::TypeParameter")
                && org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(type, SLOT_OWNER) == original)
        {
            ...
            org.finos.legend.pure.truffle.compiler.helper._Any.write(tpCopy, "owner", copy);
            org.finos.legend.pure.truffle.compiler.helper._Any.write(result, "type", tpCopy);
        }
        else
        {
            org.finos.legend.pure.truffle.compiler.helper._Any.write(result, "type", type);
        }
        // Deep-copy typeArguments recursively
        Object taObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(gtv, SLOT_TYPE_ARGUMENTS);
        if (taObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence typeArgs && !typeArgs.isEmpty())
        {
            ...
            for (int i = 0; i < typeArgs.size(); i++)
            {
                ...
                // GenericTypeValue uniformly via _Any.read.
                if (ta != null && org.finos.legend.pure.truffle.compiler.helper._Any.isType(ta,
            ...
            org.finos.legend.pure.truffle.compiler.helper._Any.write(result, "typeArguments",
                    new org.finos.legend.pure.truffle.execution.types.ObjectSequence(copied));
        }
        return result;
    }
}
