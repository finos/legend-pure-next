...
public final class FbsResolverHelper
{
    ...
    private static Object resolveProperty(String ownerPath, String propName, MetadataAccess resolver)
    {
    ...
    private static Object resolveQualifiedProperty(String ownerPath, String qpName, MetadataAccess resolver)
    {
        Object owner = resolver.getElement(ownerPath);
        if (owner != null)
        {
    ...
    private static Object resolveStereotype(String profilePath, String stereoName, MetadataAccess resolver)
    {
    ...
    private static Object resolveTag(String profilePath, String tagName, MetadataAccess resolver)
    {
        Object owner = resolver.getElement(profilePath);
        if (owner != null)
        {
     ...
     */
    public static Object resolveNestedElement(String path, MetadataAccess resolver)
    {
