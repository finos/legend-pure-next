...
public final class RangeNode extends PureNode
{
    ...
    private Object build(long start, long stop, long step)
    {
        if (step == 0)
        {
            ...
            throw new org.finos.legend.pure.truffle.execution.ast.PureException.AssertionError("range step must not be 0", null);
        }
        ...
        return new org.finos.legend.pure.truffle.execution.types.LongSequence(values);
    }
}
