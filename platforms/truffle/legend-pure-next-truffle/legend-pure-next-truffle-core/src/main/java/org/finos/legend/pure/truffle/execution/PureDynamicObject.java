...
import org.finos.legend.pure.truffle.compiler.module.PureClassInfo;
...
import org.finos.legend.pure.truffle.compiler.module.pdbModule.GenericFbDecoder;
...
public class PureDynamicObject implements PropertyAccessor, TruffleObject
{
    ...
    private Object decodeFromFb(String name)
    {
        ...
        return GenericFbDecoder.decode(
                name, fb, (MetadataAccess) resolver, this);
    }
