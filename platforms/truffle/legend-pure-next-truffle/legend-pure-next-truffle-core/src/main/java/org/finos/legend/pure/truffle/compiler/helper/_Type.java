...
public final class _Type
{
    ...
    public static List<Object> linearize(Object type, MetadataAccess resolver)
    {
    ...
    @SuppressWarnings("unchecked")
    public static boolean subtypeOf(Object sub, Object sup, MetadataAccess resolver)
    {
        if (sub == sup)
        {
            return true;
    ...
    public static Object findCommonType(List<?> types, boolean contravariant, MetadataAccess resolver)
    {
     ...
     * ModuleRegistry.elementCache}), so the cost is one hash + reference
     ...
     */
    private static boolean isTopType(Object type, MetadataAccess resolver)
    {
        ...
        return "Any".equals(_Any.readBySlot(type, SLOT_NAME));
    }
