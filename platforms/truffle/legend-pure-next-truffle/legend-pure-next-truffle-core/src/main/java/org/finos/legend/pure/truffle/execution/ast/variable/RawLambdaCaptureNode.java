...
package org.finos.legend.pure.truffle.execution.ast.variable;
...
public final class RawLambdaCaptureNode extends PureNode
{
    ...
    public RawLambdaCaptureNode(Object lambda,
                                org.finos.legend.pure.truffle.execution.types.PureSequence openVars,
                                FrameLayout layout)
    {
        this.lambda = lambda;
        ...
        for (int i = 0; i < openVars.size(); i++)
        {
            ...
            String name;
            if (org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(varObj,
                    "meta::pure::metamodel::valuespecification::VariableExpression"))
            {
                name = (String) org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(varObj, SLOT_NAME);
            }
            else
            {
