...
public final class AssertNode extends PureNode
{
    ...
    @Child
    private org.finos.legend.pure.truffle.execution.ast.call.RawLambdaCallNode msgCallNode = new org.finos.legend.pure.truffle.execution.ast.call.RawLambdaCallNode();
    ...
    public Object executeGeneric(VirtualFrame frame)
    {
        if (!conditionArg.executeBoolean(frame))
        {
            ...
            {
                throw new org.finos.legend.pure.truffle.execution.ast.PureException.AssertionError("Assert failed", this);
            }
        }
        return true;
    }
    ...
    private void throwWithMessage(Object msgFn)
    {
        ...
        throw new org.finos.legend.pure.truffle.execution.ast.PureException.AssertionError(String.valueOf(message), this);
    }
}
