...
public final class CompareNode extends PureNode
{
    ...
    private static long doCompare(Object rawA, Object rawB)
    {
        ...
        if (rawA instanceof PureDate && rawB instanceof String s && org.finos.legend.pure.truffle.execution.natives.string.ToStringNode.isDateString(s))
        {
            rawB = PureDate.of(s, s.contains("T") ? "DateTime" : "Date");
        }
        else if (rawB instanceof PureDate && rawA instanceof String s && org.finos.legend.pure.truffle.execution.natives.string.ToStringNode.isDateString(s))
        {
        ...
        if (rawA instanceof PureDate pdA && rawB instanceof PureDate pdB)
        {
            try
            {
                java.time.LocalDateTime dtA = org.finos.legend.pure.truffle.execution.natives.date.DateHelper.parseDate(pdA.dateString());
                java.time.LocalDateTime dtB = org.finos.legend.pure.truffle.execution.natives.date.DateHelper.parseDate(pdB.dateString());
        ...
        if (a instanceof String sA && b instanceof String sB)
        {
            ...
            {
                String n1 = org.finos.legend.pure.truffle.execution.natives.date.DateHelper.normalizePureDate(sA);
                String n2 = org.finos.legend.pure.truffle.execution.natives.date.DateHelper.normalizePureDate(sB);
