...
public final class CastNode extends PureNode
{
    ...
    private static final int SLOT_CONSTRAINTS = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("constraints");
    private static final int SLOT_FUNCTION_DEFINITION = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("functionDefinition");
    ...
    private static final int SLOT_MESSAGE_FUNCTION = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("messageFunction");
    ...
    private static Object doCast(Object inputResult, Object targetResult, MetadataAccess resolver, RawLambdaCallNode constraintCallNode)
    {
        ...
        Object hoistedGT = targetResult != null
                ? org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(targetResult, SLOT_GENERIC_TYPE) : null;
        if (hoistedGT != null)
        {
            org.finos.legend.pure.truffle.execution.types.PureSequence hoistedTypeArgs =
                    org.finos.legend.pure.truffle.compiler.helper._GenericType.typeArguments(hoistedGT);
            if (hoistedTypeArgs != null && hoistedTypeArgs.size() > 0)
            {
                ...
                targetType = org.finos.legend.pure.truffle.compiler.helper._GenericType.type(rawTargetGT);
            }
            ...
            Object mulArgsObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(hoistedGT,
                    org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("multiplicityArguments"));
            if (mulArgsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence mulArgs && mulArgs.size() > 0)
            {
        ...
        boolean targetTypeUndefined = targetGT != null
                && org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(targetGT,
                        "meta::pure::metamodel::type::generics::UndefinedGenericType");
        boolean targetMulUndefined = targetMul != null
                && org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(targetMul,
        ...
        org.finos.legend.pure.truffle.execution.PureContext ctxForBindings = null;
        if (!targetTypeUndefined
                && targetType != null
                && org.finos.legend.pure.truffle.compiler.helper._Any.isType(targetType,
                        "meta::pure::metamodel::type::generics::TypeParameter", resolver))
        {
            Object tvNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(targetType, SLOT_NAME);
            String tvName = tvNameObj instanceof String s ? s : null;
            ctxForBindings = org.finos.legend.pure.truffle.execution.PureLanguage.get(null);
        ...
        if (!targetMulUndefined
                && targetMul != null
                && org.finos.legend.pure.truffle.compiler.helper._Any.isType(targetMul,
                        "meta::pure::metamodel::multiplicity::MultiplicityParameter", resolver))
        {
            Object mvNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(targetMul, SLOT_NAME);
            String mvName = mvNameObj instanceof String s ? s : null;
            if (ctxForBindings == null) ctxForBindings = org.finos.legend.pure.truffle.execution.PureLanguage.get(null);
                ...
                && targetType != null)
        {
                    ...
                    && !targetPath.startsWith("meta::pure::metamodel::valuespecification::"))
            {
                ...
                if (sourceType != null)
                {
                    String sourcePath = org.finos.legend.pure.truffle.compiler.helper._PackageableElement.path(sourceType, resolver);
                    if (sourcePath != null && !"meta::pure::metamodel::type::Nil".equals(sourcePath))
                    {
                        boolean related = false;
                        try
                        {
                            related = org.finos.legend.pure.truffle.compiler.helper._Type.subtypeOf(sourceType, targetType, resolver)
                                    || org.finos.legend.pure.truffle.compiler.helper._Type.subtypeOf(targetType, sourceType, resolver);
                        }
                        catch (Exception e)
                        {
                        ...
                        if (!related)
                        {
                            Object srcName = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(sourceType, SLOT_NAME);
                            Object tgtName = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(targetType, SLOT_NAME);
        ...
        if (targetType != null && inputResult != null
                && !(inputResult instanceof org.finos.legend.pure.truffle.execution.types.PureSequence ps2 && ps2.isEmpty()))
        {
            ...
            java.util.Set<Object> visited)
    {
        ...
        Object constraintsObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(type, SLOT_CONSTRAINTS);
        if (constraintsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence constraints && !constraints.isEmpty())
        {
            return true;
        }
        Object gens = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(type, SLOT_GENERALIZATIONS);
        if (gens instanceof org.finos.legend.pure.truffle.execution.types.PureSequence genSeq)
        {
            for (Object gen : genSeq.toBoxedArray())
            {
                ...
                if (general != null)
                {
                    var superType = org.finos.legend.pure.truffle.compiler.helper._GenericType.type(general);
                                            ...
                                            RawLambdaCallNode constraintCallNode)
    {
        ...
        if (org.finos.legend.pure.truffle.compiler.helper._PackageableElement.pointerPath(type) != null)
        {
            return;
        }
        ...
        if (gens instanceof org.finos.legend.pure.truffle.execution.types.PureSequence genSeq)
        {
            for (Object gen : genSeq.toBoxedArray())
            {
                Object general = gen != null
                        ? org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(gen, SLOT_GENERAL) : null;
                Object genType =
                        general != null ? org.finos.legend.pure.truffle.compiler.helper._GenericType.type(general) : null;
                                                   ...
                                                   RawLambdaCallNode constraintCallNode)
    {
        ...
        Object typeNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(type, SLOT_NAME);
        ...
        Object typeVarValsObj = targetGT != null
                ? org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(targetGT, SLOT_TYPE_VARIABLE_VALUES) : null;
        if (typeVarValsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence typeVarVals
                && typeVarVals.size() > 0)
        {
            Object typeVarsObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(type, SLOT_TYPE_VARIABLES);
            if (typeVarsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence typeVars)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(rawVal,
                            "meta::pure::metamodel::valuespecification::AtomicValue"))
                    {
                        Object inner = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(rawVal, SLOT_VALUE);
                        if (inner != null) rawVal = inner;
                    }
                    Object rawTypeVar = typeVars.getBoxed(i);
                    Object tvNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(rawTypeVar, SLOT_NAME);
        ...
        for (int idx = 0; idx < constraints.size(); idx++)
        {
            ...
            Object funcDef = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(c, SLOT_FUNCTION_DEFINITION);
            if (funcDef == null)
            {
                continue;
            }
            ...
            Object funcParamsObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(funcDef, SLOT_PARAMETERS);
            if (funcParamsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence funcParams && funcParams.size() > 1)
            {
                for (int p = 1; p < funcParams.size(); p++)
                {
                    Object rawParam = funcParams.getBoxed(p);
                    Object tvNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(rawParam, SLOT_NAME);
                    if (tvNameObj instanceof String tvName)
                    {
            ...
            {
                Object cNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(c, SLOT_NAME);
                ...
                Object messageFn = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(c, SLOT_MESSAGE_FUNCTION);
                if (messageFn != null)
                {
                    try
                    {
                        ...
                        msgArgs.add(value);
                        Object msgParamsObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(messageFn, SLOT_PARAMETERS);
                        if (msgParamsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence msgParams && msgParams.size() > 1)
                        {
    ...
    private static int inputCount(Object value)
    {
        ...
        if (value instanceof org.finos.legend.pure.truffle.execution.types.PureSequence seq) return seq.size();
        return 1;
    }
    ...
    {
        Object lowerBound = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(concreteMul,
                org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("lowerBound"));
        Object upperBound = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(concreteMul,
