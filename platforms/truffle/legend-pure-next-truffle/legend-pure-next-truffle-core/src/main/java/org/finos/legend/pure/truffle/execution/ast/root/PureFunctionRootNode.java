...
package org.finos.legend.pure.truffle.execution.ast.root;
...
public final class PureFunctionRootNode extends RootNode
{
    ...
    public Object execute(VirtualFrame frame)
    {
        ...
        org.finos.legend.pure.truffle.execution.profiler.PureProfiler.enter(name);
        ...
        org.finos.legend.pure.truffle.execution.PureContext ctx =
                (hasFuncTypeVars || hasFuncMulVars) ? org.finos.legend.pure.truffle.execution.PureLanguage.get(this) : null;
        if (hasFuncTypeVars)
        {
        ...
        org.finos.legend.pure.truffle.execution.profiler.PureProfiler.exit();
        return result;
    }
    ...
    private java.util.Map<String, Object> buildFuncTypeVarBindings(Object[] arguments)
    {
        ...
        MetadataAccess resolver =
                org.finos.legend.pure.truffle.execution.PureLanguage.get(this).resolver();
    ...
    private static int countOfArg(Object arg)
    {
        ...
        if (arg instanceof org.finos.legend.pure.truffle.execution.types.PureSequence seq) return seq.size();
        return 1;
    }
    ...
    private static Object resolveTypeFromArgument(Object arg,
                                                  MetadataAccess resolver)
    {
        if (arg instanceof org.finos.legend.pure.truffle.execution.PureDynamicObject)
        {
            Object cgt = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(arg,
                    org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("classifierGenericType"));
            return cgt != null ? org.finos.legend.pure.truffle.compiler.helper._GenericType.type(cgt) : null;
        }
        if (arg instanceof org.finos.legend.pure.truffle.execution.types.PureSequence seq)
        {
            ...
            return org.finos.legend.pure.truffle.compiler.helper._Type.findCommonType(distinct, false, resolver);
        }
