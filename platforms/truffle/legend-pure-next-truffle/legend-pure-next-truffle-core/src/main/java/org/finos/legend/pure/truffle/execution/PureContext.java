...
import org.finos.legend.pure.truffle.execution.ast.root.CompiledFunction;
import org.finos.legend.pure.truffle.execution.FrameDescriptorBuilder;
import org.finos.legend.pure.truffle.execution.ast.root.FrameLayout;
import org.finos.legend.pure.truffle.grammar.TrufflePureParser;
import org.finos.legend.pure.truffle.compiler.module.MetadataAccess;
import org.finos.legend.pure.truffle.execution.ast.root.PureFunctionRootNode;
import org.finos.legend.pure.truffle.execution.ast.root.RawLambdaRootNode;
...
public final class PureContext
{
    ...
    private static final int SLOT_CLASSIFIER_GENERIC_TYPE = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("classifierGenericType");
    ...
    private static final int SLOT_SOURCE_ID = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("sourceId");
    private static final int SLOT_SOURCE_INFORMATION = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("sourceInformation");
    private static final int SLOT_START_COLUMN = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("startColumn");
    private static final int SLOT_START_LINE = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("startLine");
    private static final int SLOT_TYPE_VARIABLE_VALUES = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("typeVariableValues");
    private static final int SLOT_TYPE_VARIABLES = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("typeVariables");
    ...
    private final java.util.Map<org.finos.legend.pure.truffle.execution.PureDynamicObject, Object> enumCgtCache =
     ...
     * loader/module → {@link ModuleRegistry#register register} again.
                    ...
                    java.util.Map<String, org.finos.legend.pure.next.parser.GrammarExtension> grammars)
    {
        ...
        // about module ownership / lifecycle. Anonymous MetadataAccess
        ...
        this.modules = (resolver instanceof ModuleRegistry r) ? r : null;
    ...
    public RootCallTarget callTargetForLambda(Object lambda)
    {
        ...
        try
        {
            ...
            try
            {
                Object exprSeqObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(lambda, SLOT_EXPRESSION_SEQUENCE);
                ...
                String[] openVarNames;
                if (!(openVarsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence openVars) || openVars.isEmpty())
                {
                ...
                else
                {
                    ...
                    for (int i = 0; i < openVars.size(); i++)
                    {
                        ...
                        Object nameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(ov, SLOT_NAME);
    ...
    public Object classifierGenericType(Object value)
    {
        ...
        // lookup entirely.
        if (value instanceof org.finos.legend.pure.truffle.execution.PureDynamicObject pdo)
        {
            ...
            // {@link EnumValueSingletons#enumerationPathOf} returns non-null only
            ...
            {
                String enumPath = org.finos.legend.pure.truffle.compiler.module.EnumValueSingletons.enumerationPathOf(pdo);
    ...
    private static final org.finos.legend.pure.truffle.compiler.module.PureClassInfo ENUM_CLASS_INFO =
            org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.enumClassInfo();

    @com.oracle.truffle.api.CompilerDirectives.TruffleBoundary
    private Object resolveStaticEnumCgt(org.finos.legend.pure.truffle.execution.PureDynamicObject pdo, String enumPath)
    {
    ...
    private static final int SLOT_CGT =
            org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("classifierGenericType");
    ...
    public Object cgtForType(String typePath)
    {
        ...
        var cgt = org.finos.legend.pure.truffle.compiler.helper._GenericType.buildUserDefinedGenericType(t, resolver);
    ...
    public Object resolveQpDispatch(Object staticQp, Object[] rawArgs)
    {
        ...
        Object runtimeType = org.finos.legend.pure.truffle.compiler.helper._GenericType.type(cgt);
        if (runtimeType == null) return staticQp;
        String qpName = (String) org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(staticQp, SLOT_NAME);
        int argCount = rawArgs.length;
        java.util.List<Object> mro =
                org.finos.legend.pure.truffle.compiler.helper._Type.linearize(runtimeType, resolver);
        for (Object type : mro)
        {
            Object qpsObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(type, SLOT_QUALIFIED_PROPERTIES);
            if (!(qpsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence qps))
            {
                continue;
            }
            for (Object candidate : qps.toBoxedArray())
            {
                ...
                if (cqpParamsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence cqpParams
                        && cqpParams.size() == argCount
                        && org.finos.legend.pure.truffle.compiler.helper._Any.isType(candidate,
    ...
    public static void bindQpTypeVariablesStatic(Object target, VirtualFrame frame, FrameLayout layout)
    {
        Object cgt = getClassifierGenericType(target);
        if (cgt == null) return;
        Object tvvObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(cgt, SLOT_TYPE_VARIABLE_VALUES);
        if (!(tvvObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence typeVarVals) || typeVarVals.isEmpty())
        {
            return;
        }
        Object ownerType = org.finos.legend.pure.truffle.compiler.helper._GenericType.type(cgt);
        Object typeVarsObj = ownerType != null
                ? org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(ownerType, SLOT_TYPE_VARIABLES) : null;
        if (!(typeVarsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence typeVars) || typeVars.isEmpty())
        {
            return;
        }
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            Object tvNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(tvObj, SLOT_NAME);
            ...
            if (slot != null)
            {
                ...
                if (org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(tvVal,
                        "meta::pure::metamodel::valuespecification::AtomicValue"))
                {
                    tvVal = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(tvVal, SLOT_VALUE);
                }
                if (tvVal != null)
                {
    ...
    private static Object getClassifierGenericType(Object target)
    {
        ...
        return org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(target, SLOT_CLASSIFIER_GENERIC_TYPE);
    }
    ...
    public org.finos.legend.pure.truffle.execution.ast.root.CompiledFunction compileLambdaFunction(Object lambda)
    {
    ...
    private CompiledFunction compile(Object fd)
    {
        ...
        try
        {
            Object exprSeqObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(fd, SLOT_EXPRESSION_SEQUENCE);
            ...
            boolean isLambda = org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(fd,
            ...
            if (!isLambda)
            {
                ...
                try
                {
                    Object si = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(fd, SLOT_SOURCE_INFORMATION);
                    if (si == null && exprSeqObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence exprSeq && !exprSeq.isEmpty())
                    {
                        Object firstExpr = exprSeq.getBoxed(0);
                        si = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(firstExpr, SLOT_SOURCE_INFORMATION);
                    }
                    rootSource = org.finos.legend.pure.truffle.execution.PureSourceHelper.createSourceSection(si);
                }
                catch (Exception e) { throw new RuntimeException("Failed to set source information", e); }
                boolean mayBindTypeVars = org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(fd,
        ...
        {
            // Evict the half-built entry: it was cached before lowering (so
            // recursive references resolve), and leaving it in would turn
            // every retry into a misleading "No CallTarget" instead of the
            // real failure below.
            functionCache.remove(fd);
    ...
    private FunctionTypeVarPlan computeFunctionTypeVarPlan(Object fd)
    {
        try
        {
            Object cgt = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(fd, SLOT_CLASSIFIER_GENERIC_TYPE);
            if (cgt == null) return FunctionTypeVarPlan.EMPTY;
            org.finos.legend.pure.truffle.execution.types.PureSequence ta = org.finos.legend.pure.truffle.compiler.helper._GenericType.typeArguments(cgt);
            ...
            Object functionType = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(functionTypeGT,
                    org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("type"));
            if (functionType == null) return FunctionTypeVarPlan.EMPTY;
            Object paramsObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(functionType, SLOT_PARAMETERS);
            ...
            int multiplicitySlot = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("multiplicity");
            for (int i = 0; i < params.size(); i++)
            {
                ...
                // would miss them.
                Object paramGT = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(param,
                ...
                if (paramGT != null)
                {
                    ...
                    if (paramType != null
                            && org.finos.legend.pure.truffle.compiler.helper._Any.isType(paramType,
                                    "meta::pure::metamodel::type::generics::TypeParameter", resolver))
                    {
                        Object nameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(paramType, SLOT_NAME);
                        if (nameObj instanceof String s)
                        {
                            tIdx.add(i);
                            tNames.add(s);
                ...
                Object paramMul = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(param, multiplicitySlot);
                if (paramMul != null
                        && org.finos.legend.pure.truffle.compiler.helper._Any.isType(paramMul,
                                "meta::pure::metamodel::multiplicity::MultiplicityParameter", resolver))
                {
                    Object nameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(paramMul, SLOT_NAME);
                    if (nameObj instanceof String s)
                    {
                        mIdx.add(i);
                        mNames.add(s);
    ...
    ParamShapePlan computeParamShapePlan(Object fd)
    {
        try
        {
            Object paramsObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(fd, SLOT_PARAMETERS);
            if (!(paramsObj instanceof org.finos.legend.pure.truffle.execution.types.PureSequence params) || params.isEmpty())
            {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                if (org.finos.legend.pure.truffle.compiler.helper._Any.isType(mul,
                        "meta::pure::metamodel::multiplicity::MultiplicityParameter", resolver))
                {
                    continue;
                }
                Object lbObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(mul, SLOT_LOWER_BOUND);
                Object ubObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(mul, SLOT_UPPER_BOUND);
    ...
    private static Long readMultiplicityBoundValue(Object boundObj)
    {
        ...
        Object v = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(boundObj,
    ...
    private String getFunctionName(Object fd)
    {
        ...
        try
        {
            Object fnNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(
                    fd, org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("functionName"));
            if (fnNameObj instanceof String fnName && !fnName.isEmpty())
            {
                Object pkg = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(
                        fd, org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("package"));
                if (pkg != null)
                {
                    String pkgPath = org.finos.legend.pure.truffle.compiler.helper._PackageableElement.path(pkg, this.resolver);
            ...
            String path = org.finos.legend.pure.truffle.compiler.helper._PackageableElement.path(fd, this.resolver);
    ...
    private static String lambdaProfileName(Object lambda)
    {
        try
        {
            Object si = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(lambda, SLOT_SOURCE_INFORMATION);
            if (si != null)
            {
                Object sourceIdObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(si, SLOT_SOURCE_ID);
                if (sourceIdObj instanceof String sourceId)
                {
                    return "lambda@" + sourceId
                            + ":" + org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(si, SLOT_START_LINE)
                            + ":" + org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(si, SLOT_START_COLUMN);
                }
            }
        }
        catch (RuntimeException ignored) {}
