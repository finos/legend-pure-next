...
import org.finos.legend.pure.truffle.execution.natives.boolean_.EqualNode;
 ...
 * {@link org.finos.legend.pure.truffle.execution.ast.call.RawLambdaCallNode#dispatch}).
...
public final class ContainsNode extends PureNode
{
    ...
    public boolean executeBoolean(VirtualFrame frame)
    {
        ...
        MetadataAccess resolver = getResolver();
        for (int i = 0; i < sz; i++)
        {
