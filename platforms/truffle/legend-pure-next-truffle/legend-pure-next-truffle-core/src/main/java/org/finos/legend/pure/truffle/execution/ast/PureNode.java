...
package org.finos.legend.pure.truffle.execution.ast;
...
public abstract class PureNode extends Node
{
     ...
     * Producers (e.g. {@link org.finos.legend.pure.truffle.execution.natives.boolean_.NotBooleanNode},
     * {@link org.finos.legend.pure.truffle.execution.natives.lang.AndNode}) override
     * this to return a primitive {@code boolean} directly — letting consumers
     * (e.g. {@link org.finos.legend.pure.truffle.execution.natives.lang.IfNode}'s
    ...
    protected final org.finos.legend.pure.truffle.execution.PureContext getContext()
    {
        return org.finos.legend.pure.truffle.execution.PureLanguage.get(this);
    }

    @com.oracle.truffle.api.CompilerDirectives.TruffleBoundary
    protected final MetadataAccess getResolver()
    {
