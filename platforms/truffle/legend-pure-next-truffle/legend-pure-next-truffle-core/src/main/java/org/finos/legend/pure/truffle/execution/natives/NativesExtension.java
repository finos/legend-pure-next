 ...
 * extension jars. {@link NativeRegistry#createDefault()} registers all
 * implementations discovered on the classpath via
 * {@code ServiceLoader.load(NativesExtension.class)}.
 *
...
public interface NativesExtension
{
     ...
     * shared {@link NativeRegistry}. Called once at runtime startup.
     */
