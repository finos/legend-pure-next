...
public final class InstanceOfNode extends PureNode
{
    ...
    private static boolean doInstanceOf(Object rawVal, Object typeResult, MetadataAccess resolver)
    {

        // Resolve the target type
        Object targetType = typeResult;

        if (rawVal == null || (rawVal instanceof org.finos.legend.pure.truffle.execution.types.PureSequence ps && ps.isEmpty()))
        {
            return false;
        }
        if (targetType == null)
        ...
        return org.finos.legend.pure.truffle.compiler.helper._Type.subtypeOf(valueType, targetType, resolver);
    }
}
