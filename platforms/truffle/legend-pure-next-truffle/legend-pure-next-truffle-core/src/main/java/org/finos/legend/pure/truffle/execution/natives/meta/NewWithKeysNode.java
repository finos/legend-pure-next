...
public final class NewWithKeysNode extends PureNode
{
    ...
    private static final int SLOT_EXPRESSION = org.finos.legend.pure.truffle.compiler.module.PureClassRegistry.globalSlot("expression");
    ...
    @Child
    private org.finos.legend.pure.truffle.execution.ast.property.PropertyWriteNode dynamicKeyWriter = new org.finos.legend.pure.truffle.execution.ast.property.PropertyWriteNode();
    ...
    public NewWithKeysNode(String signature, PureNode typeHolderNode, org.finos.legend.pure.truffle.execution.ast.property.PropertyAssignNode[] assignments)
    {
        this(signature, typeHolderNode, assignments, null);
    }

    public NewWithKeysNode(String signature, PureNode typeHolderNode, org.finos.legend.pure.truffle.execution.ast.property.PropertyAssignNode[] assignments, PureNode keysNode)
    {
        ...
        try
        {
            ...
            for (int i = 0; i < assignments.length; i++)
            {
                if ("classifierGenericType".equals(assignments[i].propertyName()))
                {
                    ...
                    if (propValue != null)
                    {
                        org.finos.legend.pure.truffle.compiler.helper._Any.write(instance, "classifierGenericType", propValue);
                    }
                    continue;
                }
    ...
    private Object[] createAndInitInstance(Object typeHolder, org.finos.legend.pure.truffle.execution.PureContext eval)
    {
        ...
        if (typeHolder != null)
        {
            Object holderGT = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(typeHolder, SLOT_GENERIC_TYPE);
            if (holderGT != null)
            {
                hoistedGt = holderGT;
                ...
                if ("Unknown".equals(classPath))
                {
                    ...
                    if (type != null)
                    {
                        String path = org.finos.legend.pure.truffle.compiler.helper._PackageableElement.path(type, eval.resolver());
        ...
        Object instance = org.finos.legend.pure.truffle.execution.TruffleInstanceFactory.createInstance(classPath, getResolver());
        ...
        if (hoistedGt != null && instance != null)
        {
            ...
            if (typeArgs != null && typeArgs.size() > 0)
            {
                ...
                if (org.finos.legend.pure.truffle.compiler.helper._Any.isType(firstArg,
                        "meta::pure::metamodel::type::generics::GenericTypeValue", eval.resolver()))
                {
                    ...
                    org.finos.legend.pure.truffle.compiler.helper._Any.write(instance, "classifierGenericType", resolved);
                }
            }
            else if (!"Unknown".equals(classPath))
            {
                ...
                if (typeElement != null)
                {
                    org.finos.legend.pure.truffle.compiler.helper._Any.write(instance, "classifierGenericType",
                            org.finos.legend.pure.truffle.compiler.helper._GenericType.buildUserDefinedGenericType(typeElement, eval.resolver()));
                }
            }
        }

        if (instance != null
                && org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(instance, SLOT_CLASSIFIER_GENERIC_TYPE) == null)
        {
            Object hgt = typeHolder != null
                    ? org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(typeHolder, SLOT_GENERIC_TYPE) : null;
                                   ...
                                   org.finos.legend.pure.truffle.execution.PureContext eval)
    {
        ...
        if (instance != null)
        {
            Object cgt = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(instance, SLOT_CLASSIFIER_GENERIC_TYPE);
            if (cgt != null)
            {
                Object type = org.finos.legend.pure.truffle.compiler.helper._GenericType.type(cgt);
                if (type != null)
                {
                                            ...
                                            java.util.List<java.util.Map.Entry<String, Object>> keyValues)
    {
        ...
        int len = org.finos.legend.pure.truffle.execution.natives.collection.CollectionHelper.size(keys);
        for (int i = 0; i < len; i++)
        {
            Object item = org.finos.legend.pure.truffle.execution.natives.collection.CollectionHelper.at(keys, i);
            if (!org.finos.legend.pure.truffle.compiler.helper._Any.pureTypeIs(item,
            ...
            Object propNameObj = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(item, SLOT_NAME);
            if (!(propNameObj instanceof String propName))
            {
                throw new RuntimeException("KeyExpression at index " + i + " has no name");
            }
            Object value = unwrapSingleton(org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(item, SLOT_EXPRESSION));
     ...
     */
    private static void validateClassifierOverride(Object proposed, Object instance, MetadataAccess resolver)
    {
        Object currentCgt = instance != null
                ? org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(instance, SLOT_CLASSIFIER_GENERIC_TYPE) : null;
        Object expected = currentCgt != null ? _GenericType.type(currentCgt) : null;
        // _GenericType.type is Object-tolerant (reads `type` via _Any.read)
        ...
        if (proposedType != null
                && org.finos.legend.pure.truffle.compiler.helper._PackageableElement.pointerPath(proposedType) != null)
        {
            return;
        }
    ...
    private static boolean samePackageableElement(Object a, Object b, MetadataAccess resolver)
    {
        if (a == b)
        {
            return true;
     ...
     */
    private static boolean isSubtypeViaGeneralizations(Object sub, Object sup, MetadataAccess resolver)
    {
        ...
        for (int depth = 0; depth < 32 && current != null; depth++)
        {
            ...
            String ptrPath = org.finos.legend.pure.truffle.compiler.helper._PackageableElement.pointerPath(current);
            if (ptrPath != null && resolver != null)
            {
                Object live = resolver.getElement(ptrPath);
                if (live != null) current = live;
            }
            Object gens = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(current, SLOT_GENERALIZATIONS);
            if (!(gens instanceof PureSequence seq) || seq.size() == 0) return false;
            Object next = null;
            for (int i = 0; i < seq.size(); i++)
            {
                Object g = seq.getBoxed(i);
                Object generalGT = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(g, SLOT_GENERAL);
            ...
            MetadataAccess resolver)
    {
        ...
        Object mulArgs = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(gtv, SLOT_MULTIPLICITY_ARGUMENTS);
                                                 ...
                                                 org.finos.legend.pure.truffle.execution.PureContext eval)
    {
        ...
        for (java.util.Map.Entry<String, Object> kv : keyValues)
        {
            ...
            if (value instanceof org.finos.legend.pure.truffle.execution.types.PureSequence seq)
            {
                if (seq.isEmpty())
                {
                    continue;
                                              ...
                                              org.finos.legend.pure.truffle.execution.ast.property.PropertyWriteNode writer)
    {
        ...
        for (java.util.Map.Entry<String, Object> kv : keyValues)
        {
            ...
            if (propValue == null || (propValue instanceof org.finos.legend.pure.truffle.execution.types.PureSequence ps2 && ps2.isEmpty()))
            {
                continue;
            }
     ...
     * {@link ModuleRegistry#reverseAssociationCandidates}.
    ...
    static String findReverseAssociationProperty(String propName, String classPath,
                                                          MetadataAccess resolver)
    {
        if (!(resolver instanceof ModuleRegistry registry))
        {
            throw new IllegalStateException(
                    "Reverse-association lookup requires a ModuleRegistry resolver, got "
                            + (resolver == null ? "null" : resolver.getClass().getName())
                            + ". The reverse-association index lives on the registry so it can be"
                            + " invalidated on register/unregister; bare MetadataAccess impls"
        ...
        for (String[] pair : candidates)
        {
            ...
            {
                var mro = org.finos.legend.pure.truffle.compiler.helper._Type.linearize(classElement, resolver);
                for (var ancestor : mro)
                {
                    if (ancestor != null
                            && targetPath.equals(org.finos.legend.pure.truffle.compiler.helper._PackageableElement.path(ancestor, resolver)))
                    {
                        return otherPropName;
                    }
                }
                                          ...
                                          org.finos.legend.pure.truffle.execution.ast.property.PropertyWriteNode writer)
    {
        ...
        // Determine if the property is multi-valued. The PDO's classInfo
        // carries per-property Java types, baked in by PureClassRegistry's
        // class-definition walk. The previous reflective fallback over
        // `target.getClass().getMethods()` covered typed XPDBHelpers —
        // post-PDO-flip no caller produces one.
        try
        {
            boolean isMulti = false;
            if (target instanceof org.finos.legend.pure.truffle.execution.PureDynamicObject pdo)
            {
                Class<?> paramType = pdo.classInfo.propTypes().get(propName);
                if (paramType != null
                        && (org.finos.legend.pure.truffle.execution.types.PureSequence.class.isAssignableFrom(paramType)
            ...
            else
            {
                ...
                boolean isEmpty = current == null
                        || (current instanceof org.finos.legend.pure.truffle.execution.types.PureSequence ps3 && ps3.isEmpty())
                ...
                else if (current instanceof PureSequence seq)
                {
                    ...
                    writer.execute(target, propName, new org.finos.legend.pure.truffle.execution.types.ObjectSequence(items));
                }
                ...
                else
                {
                    writer.execute(target, propName,
                            new org.finos.legend.pure.truffle.execution.types.ObjectSequence(new Object[]{current, value}));
                }
            }
        }
        catch (Exception e)
