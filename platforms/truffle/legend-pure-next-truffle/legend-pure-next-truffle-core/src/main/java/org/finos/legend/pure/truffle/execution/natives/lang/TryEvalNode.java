...
public final class TryEvalNode extends PureNode
{
    ...
    @TruffleBoundary
    private Object doTryEval(Object rawFn, MetadataAccess resolver)
    {
        Object tryResult = TruffleInstanceFactory.createInstance(TRY_RESULT_PATH, resolver);
        try
        {
            Object value = invokeClosure(rawFn);
            _Any.write(tryResult, "value", value);
        }
        catch (Throwable t)
        {
            _Any.write(tryResult, "failure", buildError(t, resolver));
        }
        return tryResult;
    }
    ...
    private Object invokeClosure(Object rawFn)
    {
        ...
        if (_Any.pureTypeIs(rawFn, LAMBDA_PATH))
        {
    ...
    private static Object buildError(Throwable t, MetadataAccess resolver)
    {
