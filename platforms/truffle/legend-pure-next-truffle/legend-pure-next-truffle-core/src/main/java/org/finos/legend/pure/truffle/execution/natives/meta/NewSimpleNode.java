...
public final class NewSimpleNode extends PureNode
{
            ...
            MetadataAccess resolver)
    {
        ...
        Object holderGT = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(result, SLOT_GENERIC_TYPE);
        PureSequence typeArgs = holderGT != null
                ? org.finos.legend.pure.truffle.compiler.helper._GenericType.typeArguments(holderGT)
                : null;
        if (typeArgs != null && typeArgs.size() > 0)
        {
            Object heldGTObj = typeArgs.getBoxed(0);
            Object heldType = org.finos.legend.pure.truffle.compiler.helper._GenericType.type(heldGTObj);
            if (heldType != null)
            {
                classPath = org.finos.legend.pure.truffle.compiler.helper._PackageableElement.path(heldType, resolver);
                if (classPath == null || classPath.isEmpty())
                {
                    Object n = org.finos.legend.pure.truffle.compiler.helper._Any.readBySlot(heldType, SLOT_NAME);
