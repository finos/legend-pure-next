 ...
 *
 * <p>Looks up the named export on a {@link JavaScriptCompilationContext}
...
public final class ExecuteNode extends PureNode
{
    ...
    public Object executeGeneric(VirtualFrame frame)
    {
        ...
        if (!(ctxRaw instanceof JavaScriptCompilationContext compCtx))
        {
            throw new RuntimeException("execute: ctx is not a JavaScriptCompilationContext (got "
    ...
    private static Object doInvoke(JavaScriptCompilationContext compCtx, String fnName, Object argsRaw, Object graph)
    {
        ...
        return JavaScriptCompileNatives.invoke(compCtx, fnName, jsArgs, graph);
    }
}
