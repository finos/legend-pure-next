 ...
 * {@link JavaScriptCompileNatives#compile} since the last drain. The
 ...
 * keeping the displayed JavaScript 100% in sync with what the PCT run ran.</p>
 */
...
public final class DrainSourcesNode extends PureNode
{
    ...
    {
        return JavaScriptCompileNatives.drainCapturedSources();
    }
}
