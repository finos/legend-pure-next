...
/**
 * Registers the {@code meta::external::language::javascript::compile} and
 * {@code meta::external::language::javascript::execute} natives. Discovered
 ...
 * here as a native.</p>
 */
public final class JavaScriptCompileNodeFactories implements TruffleNativesExtension
{
    @Override
