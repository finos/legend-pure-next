...
/** {@code find} with predicate body inlined as {@code @Child}. Returns the
 *  first element for which the predicate is true, or empty. Subframe pattern
 *  — see {@link InlineFoldNode}. */
@NodeInfo(shortName = "inlineFind")
public final class InlineFindNode extends PureNode
{
    ...
    public InlineFindNode(PureNode collection, PureNode[] body,
    ...
    public Object executeGeneric(VirtualFrame frame)
    {
        ...
        for (int i = 0; i < sz; i++)
        {
            ...
            if (result instanceof Boolean bl && bl) return item;
        }
