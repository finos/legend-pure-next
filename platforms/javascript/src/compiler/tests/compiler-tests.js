...
//
// Run: node --stack-size=4000 src/compiler/tests/compiler-tests.js [--roundtrip] [--golden]
...
async function main() {
    ...
    const { parse, compile, printGraph, store } = await loadCompiler();
            ...
            if (isError) {
                ...
                if (roundtrip) {
                    ...
                    try {
                        ...
                        const reprint = withModule(store, rt.module, () =>
                ...
                if (golden) {
                    ...
                    if (existsSync(gpath)) {
                        ...
                        try {
                            ...
                            const findings = diffArchives(store.schema, js, java);
