...
import { openZip } from "../pdbModule/zip/zip.js";
import { PdbModule } from "../ModuleRegistry.js";
...
export function roundTripElements(elements, referencedBy) {
    ...
    const module = new PdbModule(fresh, "round-trip archive"); // identity from the writer's manifest
