...
// Translation helpers behind the compileSource native (natives/CompileSourceExtension.js),
// shared by every JS host (Node execution host, browser page). Host-agnostic: it only touches
