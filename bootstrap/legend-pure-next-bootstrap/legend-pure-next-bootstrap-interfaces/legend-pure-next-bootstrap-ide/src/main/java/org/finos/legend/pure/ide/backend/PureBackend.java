 ...
 *
 * <p>Diagnostics + navigation stay on the Java compiler's {@link ModuleRegistry} in both
 * backends (the compiled registry is portable and Java-direct's compile is the fastest
 * path for compile-on-save). Backends diverge at execute time:</p>
 * <ul>
 *   <li>Java-direct uses the supplied {@link ModuleRegistry} and
 *       {@link FunctionDefinition} directly via {@code PureRuntime}.</li>
 ...
 *       invoked through {@code PureRuntime}, then finds the target
...
public interface PureBackend
{
     ...
     *
     * <p>Java-direct uses {@code registry} + {@code function} directly and
     ...
     */
    ExecutionResult execute(MutableList<SourceModule> editableModules,
