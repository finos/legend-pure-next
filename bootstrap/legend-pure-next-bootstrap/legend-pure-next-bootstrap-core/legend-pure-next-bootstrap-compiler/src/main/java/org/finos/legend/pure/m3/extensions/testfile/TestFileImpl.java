...
/**
 * Compiled model element for {@code ###File} test sections.
 */
public class TestFileImpl implements PackageableElement
{
    private String name;
    ...
    public TestFileImpl _name(String value)
    {
        this.name = value;
        return this;
    }
    ...
    public TestFileImpl _package(Package value)
    {
        this.package_ = value;
        return this;
    }
    ...
    public TestFileImpl _value(String value)
    {
        this.value = value;
        return this;
    }
