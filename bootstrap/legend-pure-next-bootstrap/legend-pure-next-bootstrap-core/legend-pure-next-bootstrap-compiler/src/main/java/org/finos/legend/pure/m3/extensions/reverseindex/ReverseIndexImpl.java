...
/**
 * Compiled model element for {@code ###ReverseIndex} test sections.
 * Carries the expected reverse-reference-index text.
 */
public class ReverseIndexImpl implements PackageableElement
{
    private String name;
    ...
    public ReverseIndexImpl _name(String value)
    {
        this.name = value;
        return this;
    }
    ...
    public ReverseIndexImpl _package(Package value)
    {
        this.package_ = value;
        return this;
    }
    ...
    public ReverseIndexImpl _value(String value)
    {
        this.value = value;
        return this;
    }
