...
public final class Closure extends LambdaFunctionImpl
{
     ...
     * @param capturedScope flat (parent-less) scope holding only the open-variable
     *                      bindings from the definition site
     */
    public Closure(LambdaFunction source, Scope capturedScope)
    {
